...
(function(M, I) {
    "object" === typeof module && module.exports
      ? ((I["default"] = I), (module.exports = M.document ? I(M) : I))
    ...
    var I = (function() {
      var a = "undefined" === typeof M ? window : M,
        ...
        G =
          z &&
          z.createElementNS &&
          !!z.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
    ...
    (function(a) {
      ...
      a.Fx.prototype = {
        dSetter: function() {
          ...
          if (1 === u) r = this.toD;
            ...
            for (; w--; )
              (x = parseFloat(a[w])),
                (r[w] = isNaN(x) ? c[w] : u * parseFloat(c[w] - x) + x);
          else r = c;
        ...
        update: function() {
          ...
          if (this[c + "Setter"]) this[c + "Setter"]();
            ...
            a.attr
              ? a.element && a.attr(c, r, null, !0)
              : (a.style[c] = r + this.unit);
          u && u.call(a, r, this);
        },
        run: function(h, c, r) {
          var u = this,
          ...
          h !== c || this.elem["forceAnimate:" + this.prop]
            ? ((this.startTime = +new Date()),
              ...
              (x.elem = this.elem),
              (x.prop = this.prop),
              x() && 1 === a.timers.push(x) && p(g))
            : (delete w.curAnim[this.prop],
              w.complete &&
                0 === Object.keys(w.curAnim).length &&
        ...
        step: function(h) {
          ...
          w.attr && !w.element
            ...
            ? ((this.now = this.end),
              ...
              r && x && x.call(w),
              (h = !1))
            : ((this.pos = u.easing((c - this.startTime) / p)),
        ...
        initPath: function(h, c, r) {
          ...
          function x(a, f) {
            for (var k = (b - a.length) / n; 0 < k && k--; )
              (l = a.slice().splice(a.length / t - n, n * t)),
                (l[0] = f[b - n - k * n]),
                m && ((l[n - 6] = l[n - 2]), (l[n - 5] = l[n - 1])),
                [].splice.apply(a, [a.length / t, 0].concat(l)),
                v && k--;
          }
          c = c || "";
          var p,
        ...
        var h,
          ...
          w = function(c, p) {
            ...
            a.objectEach(p, function(g, d) {
              !a.isObject(g, !0) || a.isClass(g) || a.isDOMElement(g)
                ? (c[d] = p[d])
                : (c[d] = w(c[d] || {}, g));
            });
            return c;
      ...
      a.css = function(h, c) {
        a.isMS &&
          ...
          c &&
          void 0 !== c.opacity &&
          (c.filter = "alpha(opacity\x3d" + 100 * c.opacity + ")");
        a.extend(h.style, c);
      };
      ...
      a.pad = function(a, c, r) {
        return (
          Array((c || 2) + 1 - String(a).replace("-", "").length).join(r || 0) + a
        );
      };
      a.relativeLength = function(a, c, r) {
        return /%$/.test(a)
          ? (c * parseFloat(a)) / 100 + (r || 0)
          : parseFloat(a);
      };
          ...
          ? ((r = (r = h.match(u)) ? r[1] : -1),
            null !== c &&
              (c = a.numberFormat(
                ...
                r,
                w.decimalPoint,
                -1 < h.indexOf(",") ? w.thousandsSep : ""
              )))
          : (c = (r || a.time).dateFormat(h, c));
        return c;
      };
      ...
      a.numberFormat = function(h, c, r, u) {
        ...
        -1 === c
          ...
          ? c &&
            ...
            ((p = c + +d[1]),
            0 <= p
              ? ((d[0] = (+d[0]).toExponential(p).split("e")[0]), (c = p))
              : ((d[0] = d[0].split(".")[0] || 0),
                (h = 20 > c ? (d[0] * Math.pow(10, d[1])).toFixed(c) : 0),
                (d[1] = 0)))
          : (c = 2);
        g = (
          Math.abs(d[1] ? d[0] : h) + Math.pow(10, -Math.max(c, x) - 1)
        ).toFixed(c);
        x = String(a.pInt(g));
      ...
      a.getStyle = function(h, c, r) {
        if ("width" === c)
          return Math.max(
            ...
            Math.min(
              h.offsetWidth,
              h.scrollWidth,
              h.getBoundingClientRect && "none" === a.getStyle(h, "transform", !1)
                ? Math.floor(h.getBoundingClientRect().width)
                : Infinity
            ) -
        ...
        if ((h = G.getComputedStyle(h, void 0)))
          (h = h.getPropertyValue(c)),
            a.pick(r, "opacity" !== c) && (h = a.pInt(h));
        return h;
      };
      ...
      a.addEvent = function(h, c, r, u) {
        ...
        w =
          "function" === typeof h && h.prototype
            ? (h.prototype.protoEvents = h.prototype.protoEvents || {})
            : (h.hcEvents = h.hcEvents || {});
        a.Point &&
          h instanceof a.Point &&
          h.series &&
          h.series.chart &&
          (h.series.chart.runTrackerClick = !0);
        x && x.call(h, c, r, !1);
        w[c] || (w[c] = []);
        w[c].push(r);
        u &&
      ...
      a.fireEvent = function(h, c, r, u) {
        var w, x, p, g, d;
        r = r || {};
        F.createEvent && (h.dispatchEvent || h.fireEvent)
          ? ((w = F.createEvent("Events")),
            w.initEvent(c, !0, !0),
            a.extend(w, r),
            h.dispatchEvent ? h.dispatchEvent(w) : h.fireEvent(c, w))
      ...
      a.animate = function(h, c, r) {
        ...
        a.isObject(r) ||
          ((g = arguments),
          (r = { duration: g[2], easing: g[3], complete: g[4] }));
        ...
        a.objectEach(c, function(d, g) {
          ...
          x = null;
          "d" === g
            ? ((p.paths = p.initPath(h, h.d, c.d)),
              (p.toD = c.d),
              (u = 0),
              (x = 1))
            : h.attr
            ? (u = h.attr(g))
            : ((u = parseFloat(a.getStyle(h, g)) || 0),
              "opacity" !== g && (w = "px"));
          x || (x = d);
      ...
      a.seriesType = function(h, c, r, u, w) {
        ...
        p[h] = a.extendClass(p[c] || function() {}, u);
          ...
          if (this[0])
            return h[0]
              ? (new a[a.isString(h[0]) ? h.shift() : "Chart"](
                ...
                this)
              : z[a.attr(this[0], "data-highcharts-chart")];
        });
    })(I);
    (function(a) {
      var z = a.isNumber,
      ...
      a.Color.prototype = {
        ...
        init: function(h) {
          ...
          if (
            ...
            this.stops = h.stops.map(function(c) {
        ...
        tweenTo: function(a, c) {
          ...
          u.length && h && h.length
            ? ((a = 1 !== u[3] || 1 !== h[3]),
              (c =
                (a ? "rgba(" : "rgb(") +
                Math.round(u[0] + (h[0] - u[0]) * (1 - c)) +
                "," +
                Math.round(u[1] + (h[1] - u[1]) * (1 - c)) +
                "," +
                Math.round(u[2] + (h[2] - u[2]) * (1 - c)) +
                (a ? "," + (u[3] + (h[3] - u[3]) * (1 - c)) : "") +
                ")"))
            : (c = a.input || "none");
          return c;
    ...
    (function(a) {
      ...
      n(z.prototype, {
        ...
        init: function(e, q) {
          this.element = "span" === q ? x(q) : m.createElementNS(this.SVG_NS, q);
          this.renderer = e;
        ...
        animate: function(e, q, b) {
          ...
          0 !== q.duration
            ? (b && (q.complete = b), h(this, e, q))
            : (this.attr(e, null, b), q.step && q.step.call(this));
          return this;
        },
        ...
        applyTextOutline: function(e) {
          ...
          -1 !== e.indexOf("contrast") &&
            (e = e.replace(/contrast/g, this.renderer.getContrast(B.style.fill)));
          e = e.split(" ");
          f = e[e.length - 1];
          if ((k = e[0]) && "none" !== k && a.svg) {
            ...
            for (d = e.length; d--; )
              (q = e[d]),
                "highcharts-text-outline" === q.getAttribute("class") &&
                  b(e, B.removeChild(q));
            l = B.firstChild;
        ...
        attr: function(e, q, b, f) {
          ...
          "string" === typeof e &&
            ...
            ((B = e), (e = {}), (e[B] = q));
          "string" === typeof e
            ? (d = (this[e + "Getter"] || this._defaultGetter).call(this, e, k))
            : (C(
                e,
                function(B, q) {
                  n = !1;
                  ...
                  this.symbolName &&
                    -1 !== a.inArray(q, J) &&
                    (l || (this.symbolAttr(e), (l = !0)), (n = !0));
                  !this.rotation ||
                    ("x" !== q && "y" !== q) ||
                    (this.doTransform = !0);
                  n ||
                    ((g = this[q + "Setter"] || this._defaultSetter),
                    g.call(this, B, q, k),
                    !this.styledMode &&
                      this.shadows &&
            ...
            a &&
              (null === a.width || "auto" === a.width
                ...
                : "text" === b.nodeName.toLowerCase() &&
                  a.width &&
                  (f = this.textWidth = e(a.width))),
            (this.styles = a),
            f && !T && this.renderer.forExport && delete a.width,
            ...
            ? ((B.ontouchstart = function(a) {
              ...
              (B.onclick = function(a) {
                (-1 === R.navigator.userAgent.indexOf("Android") ||
                  1100 < Date.now() - (q.touchEventFired || 0)) &&
                  e.call(B, a);
              }))
            : (B["on" + a] = e);
          return this;
            ...
            : k &&
              a.push(
                "rotate(" +
                  k +
                  " " +
                  y(this.rotationOriginX, d.getAttribute("x"), 0) +
                  " " +
                  y(this.rotationOriginY, d.getAttribute("y") || 0) +
                  ")"
              );
        ...
        align: function(a, e, q) {
          ...
          if (a) {
            if (
              ((this.alignOptions = a), (this.alignByTranslate = e), !q || D(q))
            )
              (this.alignTo = B = q || "renderer"),
                b(k, this),
                k.push(this),
                (q = null);
          } else
        ...
        getBBox: function(a, e) {
          ...
          p(d) &&
            ...
            (c += ["", e || 0, l, this.textWidth, k && k.textOverflow].join()));
          c && !a && (q = m[c]);
          if (!q) {
            if (v || B.forExport) {
              try {
              ...
              v &&
                (q.height = B =
                  { "11px,17": 14, "13px,20": 16 }[
                    k && k.fontSize + "," + Math.round(B)
                  ] || B),
              e &&
                ((q.width =
                  Math.abs(B * Math.sin(b)) + Math.abs(a * Math.cos(b))),
                (q.height =
                  Math.abs(B * Math.cos(b)) + Math.abs(a * Math.sin(b)))));
            if (c && 0 < q.height) {
          ...
          if (!a) this.destroyShadows();
            ...
            for (f = 1; f <= d; f++)
              (B = k.cloneNode(0)),
                ...
                q &&
                  (c(B, "height", Math.max(c(B, "height") - l, 0)),
                  (B.cutHeight = l)),
                e
                  ? e.element.appendChild(B)
                  : k.parentNode && k.parentNode.insertBefore(B, k),
                b.push(B);
            this.shadows = b;
          }
          return this;
        ...
        titleSetter: function(a) {
          ...
          e ||
            ((e = m.createElementNS(this.SVG_NS, "title")),
        ...
        zIndexSetter: function(a, q) {
          ...
          p(a)
            ? (d.setAttribute("data-z-index", a),
              (a = +a),
              this[q] === a && (l = !1))
            : p(this[q]) && d.removeAttribute("data-z-index");
          this[q] = a;
          if (l) {
            ...
            for (g = q.length - 1; 0 <= g && !B; g--)
              if (
                ((f = q[g]),
                (l = f.getAttribute("data-z-index")),
                (n = !p(l)),
                f !== d)
              )
                if (0 > a && n && !b && !g) k.insertBefore(d, q[g]), (B = !0);
                else if (e(l) <= a || (n && (!p(a) || 0 <= a)))
                  k.insertBefore(d, q[g + 1] || null), (B = !0);
      ...
      z.prototype.translateXSetter = z.prototype.translateYSetter = z.prototype.rotationSetter = z.prototype.verticalAlignSetter = z.prototype.rotationOriginXSetter = z.prototype.rotationOriginYSetter = z.prototype.scaleXSetter = z.prototype.scaleYSetter = z.prototype.matrixSetter = function(
        a,
        e
      ) {
        this[e] = a;
      ...
      z.prototype["stroke-widthSetter"] = z.prototype.strokeSetter = function(
        a,
        e,
        q
      ) {
        ...
        this.stroke && this["stroke-width"]
          ? (z.prototype.fillSetter.call(this, this.stroke, "stroke", q),
            q.setAttribute("stroke-width", this["stroke-width"]),
            (this.hasStroke = !0))
          : "stroke-width" === e &&
            0 === a &&
            this.hasStroke &&
            (q.removeAttribute("stroke"), (this.hasStroke = !1));
      };
      ...
      n(F.prototype, {
        ...
        init: function(a, e, q, b, f, k, l) {
          ...
          this.alignedObjects = [];
          this.url =
            (v || A) && m.getElementsByTagName("base").length
              ? R.location.href
                  .split("#")[0]
                  .replace(/<[^>]*>/g, "")
                  .replace(/([\('\)])/g, "\\$1")
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              m.createTextNode("Created with Highcharts 7.0.2")
            );
          ...
          v &&
            ...
            e(),
            (this.unSubPixelFix = G(R, "resize", e)));
        },
        definition: function(a) {
          function e(a, b) {
            ...
            L(a).forEach(function(a) {
              ...
              k.add(b || q.defs);
              a.textContent &&
                k.element.appendChild(m.createTextNode(a.textContent));
              e(a.children || [], k);
              f = k;
            });
            return f;
            ...
            v = function(k, n) {
              ...
              if (void 0 === c[n])
                if (e.getSubStringLength)
                  ...
                  d.getSpanWidth &&
                    (p(l(q || b, k)), (c[n] = f + d.getSpanWidth(a, e)));
              return c[n];
            },
            t,
            C;
        ...
        buildText: function(a) {
          var q = a.element,
            ...
            N = function(a) {
              ...
              return p
                ? e(p)
                : b.fontMetrics(k, a.getAttribute("style") ? a : q).h;
            },
            D = function(a, e) {
              C(b.escapes, function(q, b) {
                (e && -1 !== e.indexOf(q)) ||
                  (a = a.toString().replace(new RegExp(q, "g"), b));
              });
              return a;
            },
            x = function(a, e) {
              ...
              if (
                ...
                return (a = a.substring(q + 1)), a.substring(0, a.indexOf(e));
            };
          ...
          if (A !== a.textCache) {
            ...
            l || v || t || E || -1 !== k.indexOf(" ")
              ? (B && B.appendChild(q),
                ...
                k.forEach(function(e, k) {
                  ...
                  l.forEach(function(e) {
                    if ("" !== e || 1 === l.length) {
                      ...
                      if ((C = x(e, "style")))
                        (C = C.replace(/(;| |^)color([ :])/, "$1fill$2")),
                          c(v, "style", C);
                      (y = x(e, "href")) &&
                        !f &&
                        (c(v, "onclick", 'location.href\x3d"' + y + '"'),
                        c(v, "class", "highcharts-anchor"),
                        b.styledMode || w(v, { cursor: "pointer" }));
                ...
                t && n && a.attr("title", D(a.textStr, ["\x26lt;", "\x26gt;"])),
                B && B.removeChild(q),
                v && a.applyTextOutline && a.applyTextOutline(v))
              : q.appendChild(m.createTextNode(D(k)));
          }
        },
        ...
        arc: function(a, e, q, b, k, f) {
          H(a)
            ? ((b = a), (e = b.y), (q = b.r), (a = b.x))
            : (b = { innerR: b, start: k, end: f });
        ...
        rect: function(a, e, q, b, k, f) {
          ...
          a = H(a)
            ...
            : void 0 === a
            ? {}
            : { x: a, y: e, width: Math.max(q, 0), height: Math.max(b, 0) };
          this.styledMode ||
        ...
        symbol: function(a, e, q, b, k, f) {
          var l = this,
            ...
            c =
              p(e) &&
              v &&
              v.call(this.symbols, Math.round(e), Math.round(q), b, k, f),
            B,
            t;
          v
            ? ((d = this.path(c)),
              l.styledMode || d.attr("fill", "none"),
              n(d, { symbolName: E, x: e, y: q, width: b, height: k }),
              f && n(d, f))
            : J &&
              ((B = a.match(g)[1]),
              (d = this.image(B)),
              (d.imgwidth = y(N[B] && N[B].width, f && f.width)),
              (d.imgheight = y(N[B] && N[B].height, f && f.height)),
              (t = function() {
              ...
              ["width", "height"].forEach(function(a) {
                d[a + "Setter"] = function(a, e) {
                  ...
                  this[e] = a;
                  p(b) &&
                    (this.element && this.element.setAttribute(e, b),
                    this.alignByTranslate ||
                      ((q[k] = ((this[e] || 0) - b) / 2), this.attr(q)));
                };
              }),
              p(e) && d.attr({ x: e, y: q }),
              (d.isImg = !0),
              p(d.imgwidth) && p(d.imgheight)
                ? t()
        ...
        symbols: {
          ...
          arc: function(a, e, q, b, k) {
            var f = k.start,
              ...
              n = k.end - 0.001;
            q = k.innerR;
            b = y(k.open, 0.001 > Math.abs(k.end - k.start - 2 * Math.PI));
            var g = Math.cos(f),
              J = Math.sin(f),
              E = Math.cos(n),
              n = Math.sin(n);
          ...
          callout: function(a, e, q, b, k) {
            ...
            d && d > q
              ...
              : d && 0 > d
              ? k > e + l && k < e + b - l
                ? n.splice(33, 3, "L", a, k + 6, a - 6, k, a, k - 6, a, e + f)
                : n.splice(33, 3, "L", a, b / 2, d, k, a, b / 2, a, e + f)
              : k && k > b && d > a + l && d < a + q - l
              ? n.splice(
                  23,
                  3,
              ...
              : k &&
                ...
                d > a + l &&
                d < a + q - l &&
                n.splice(3, 3, "L", d - 6, e, d, e - 6, d + 6, e, q - f, e);
            return n;
          }
        },
        ...
        fontMetrics: function(a, q) {
          a =
            (!this.styledMode && /px/.test(a)) || !R.getComputedStyle
              ...
              : q && z.prototype.getStyle.call(q, "font-size");
          a = /px/.test(a) ? e(a) : 12;
        ...
        label: function(e, b, f, d, l, g, J, E, v) {
          ...
          U = function() {
            var a = C.element.style,
              e = {};
            L =
              (void 0 === H || void 0 === h || T) && p(C.textStr) && C.getBBox();
            t.width = (H || L.width || 0) + 2 * y + A;
            t.height = (h || L.height || 0) + 2 * y;
            u =
              y +
              Math.min(
                m.fontMetrics(a && a.fontSize, C).b,
                L ? L.height : Infinity
              );
            w &&
              (K ||
                ((t.box = K = m.symbols[d] || R ? m.symbol(d) : m.rect()),
                K.addClass(
                  ("button" === v ? "" : "highcharts-label-box") +
                    (v ? " highcharts-" + v + "-box" : "")
                ),
                K.add(t),
                (a = P()),
          ...
          O = function() {
            ...
            p(H) &&
              L &&
              ("center" === T || "right" === T) &&
              (a += { center: 0.5, right: 1 }[T] * (H - L.width));
            if (a !== C.x || e !== C.y)
              C.attr("x", a),
                C.hasBoxWidthChanged && ((L = C.getBBox(!0)), U()),
                void 0 !== e && C.attr("y", e);
            C.x = a;
            C.y = e;
          };
          ...
          t.xSetter = function(a) {
            t.x = a;
            B &&
              ((a -= B * ((H || L.width) + 2 * y)), (t["forceAnimate:x"] = !0));
            N = Math.round(a);
            t.attr("translateX", N);
          };
    ...
    (function(a) {
      ...
      c(g.prototype, {
        ...
        htmlUpdateTransform: function() {
          if (this.added) {
            ...
            this.inverted &&
              b.childNodes.forEach(function(e) {
                a.invertChild(e, b);
              });
            if ("SPAN" === b.tagName) {
              var A = this.rotation,
                ...
                y;
              (y = E !== this.oldTextWidth) &&
                !(y = E > this.oldTextWidth) &&
                ((y = this.textPxLength) ||
                  (G(b, { width: "", whiteSpace: k || "nowrap" }),
                  (y = b.offsetWidth)),
                (y = y > E));
              y &&
              ...
              C !== this.cTT &&
                ((k = a.fontMetrics(b.style.fontSize, b).b),
                !h(A) ||
                  (A === (this.oldRotation || 0) && m === this.oldAlign) ||
                  this.setSpanRotation(A, c, k),
                this.getSpanCorrection(
                  (!h(A) && this.textPxLength) || b.offsetWidth,
                  k,
                  c,
                  A,
                  m
        ...
        setSpanRotation: function(a, b, d) {
          ...
          f[l + (r ? "Origin" : "-origin")] = f.transformOrigin =
            100 * b + "% " + d + "px";
          G(this.element, f);
        },
      ...
      c(d.prototype, {
        getTransformKey: function() {
          return u && !/Edge/.test(m.navigator.userAgent)
            ? "-ms-transform"
            : w
            ? "-webkit-transform"
            : r
        ...
        html: function(d, b, l) {
          ...
          f.attr({ text: d, x: Math.round(b), y: Math.round(l) }).css({
            position: "absolute"
          });
          A ||
            f.css({
    ...
    (function(a) {
      ...
      a.Time.prototype = {
            ...
            ? ((this.get = function(a, g) {
              ...
              (this.set = function(a, g, d) {
                ...
                if (
                  "Milliseconds" === a ||
                  "Seconds" === a ||
                  ("Minutes" === a && 0 === g.getTimezoneOffset() % 60)
                )
                  g["set" + a](d);
                else
                  (m = x.getTimezoneOffset(g)),
                    (m = g.getTime() - m),
                    g.setTime(m),
                    g["setUTC" + a](d),
                    (a = x.getTimezoneOffset(g)),
                    (m = g.getTime() + a),
                    g.setTime(m);
              }))
            : c
        ...
        resolveDTLFormat: function(c) {
          return a.isObject(c, !0)
            ? c
            : ((c = a.splat(c)), { main: c[0], from: c[1], to: c[2] });
        },
        getTimeTicks: function(a, r, x, p) {
          ...
          if (z(r)) {
            g.set(
              "Milliseconds",
              m,
              l >= c.second ? 0 : f * Math.floor(g.get("Milliseconds", m) / f)
            );
            l >= c.second &&
              g.set(
                "Seconds",
                m,
                l >= c.minute ? 0 : f * Math.floor(g.get("Seconds", m) / f)
              );
            l >= c.minute &&
              g.set(
                "Minutes",
                m,
                l >= c.hour ? 0 : f * Math.floor(g.get("Minutes", m) / f)
              );
            l >= c.hour &&
              g.set(
                "Hours",
                m,
                l >= c.day ? 0 : f * Math.floor(g.get("Hours", m) / f)
              );
            l >= c.day &&
              g.set(
                "Date",
                ...
                l >= c.month
                  ? 1
                  : Math.max(1, f * Math.floor(g.get("Date", m) / f))
              );
            l >= c.month &&
              (g.set(
                "Month",
                m,
                l >= c.year ? 0 : f * Math.floor(g.get("Month", m) / f)
              ),
              (b = g.get("FullYear", m)));
            l >= c.year && g.set("FullYear", m, b - (b % f));
            l === c.week &&
              ((b = g.get("Day", m)),
              g.set("Date", m, g.get("Date", m) - b + p + (b < p ? -7 : 0)));
            b = g.get("FullYear", m);
            p = g.get("Month", m);
            var t = g.get("Date", m),
              H = g.get("Hours", m);
            ...
            g.variableTimezone &&
              (v =
                x - r > 4 * c.month ||
                g.getTimezoneOffset(r) !== g.getTimezoneOffset(x));
            r = m.getTime();
            for (m = 1; r < x; )
              d.push(r),
                (r =
                  l === c.year
                    ...
                    : !v || (l !== c.day && l !== c.week)
                    ? v && l === c.hour && 1 < f
                      ? g.makeTime(b, p, t, H + m * f)
                      : r + l * f
                    : g.makeTime(b, p, t + m * f * (l === c.day ? 1 : 7))),
                m++;
            d.push(r);
            l <= c.hour &&
              1e4 > d.length &&
              d.forEach(function(a) {
                0 === a % 18e5 &&
                  "000000000" === g.dateFormat("%H%M%S%L", a) &&
                  (n[a] = "day");
              });
          }
      ...
      a.Tick.prototype = {
        addLabel: function() {
          ...
          p.isDatetimeAxis &&
            ...
            ((A = d.time.resolveDTLFormat(
              g.dateTimeLabelFormats[(!g.grid && f.higherRanks[b]) || f.unitName]
            )),
            (D = A.main));
          c.isFirst = v;
          c.isLast = t;
                ...
                if (
                  (h.attr({
                    text: p.labelFormatter.call(
                      a.extend(c.formatCtx, { dateTimeLabelFormat: E[k] })
                    )
                  }),
                  h.getBBox().width < p.getSlotWidth(c) - 2 * u(l.padding, 5))
                )
                  return;
              h.attr({ text: "" });
            };
          if (F(h))
            ...
            if (
              (c.label = h =
                F(g) && l.enabled
                  ? d.renderer.text(g, 0, 0, l.useHTML).add(p.labelGroup)
                  : null)
            )
              d.styledMode || h.css(r(l.style)),
        ...
        handleOverflow: function(a) {
          var c = this.axis,
            ...
            n = u(
              c.labelRight,
              Math.max(c.isRadial ? 0 : c.pos + c.len, m - n[1])
            ),
            l = this.label,
            f = this.rotation,
            ...
            k,
            E = {};
          if (f || "justify" !== u(g.overflow, "justify"))
            0 > f && d - v * t < b
              ? (k = Math.round(d / Math.cos(f * w) - b))
              : 0 < f &&
                d + v * t > n &&
                (k = Math.round((m - d) / Math.cos(f * w)));
          else if (
            ((m = d + (1 - v) * t),
            d - v * t < b
              ? (D = a.x + D * (1 - v) - b)
            ...
            t > D || (c.autoRotation && (l.styles || {}).width))
          )
            k = D;
          k &&
            (this.shortenLabel
              ? this.shortenLabel()
              : ((E.width = Math.floor(k)),
                (g.style || {}).textOverflow || (E.textOverflow = "ellipsis"),
                l.css(E)));
        },
        getPosition: function(c, p, g, d) {
          var m = this.axis,
            n = m.chart,
            b = (d && n.oldChartHeight) || n.chartHeight;
          c = {
            x: c
              ? a.correctFloat(m.translate(p + g, null, null, d) + m.transB)
              : m.left +
                m.offset +
                (m.opposite
                  ? ((d && n.oldChartWidth) || n.chartWidth) - m.right - m.left
                  : 0),
            y: c
              ? b - m.bottom + m.offset - (m.opposite ? m.height : 0)
              : a.correctFloat(b - m.translate(p + g, null, null, d) - m.transB)
          };
          ...
          F(A) ||
            (A =
              0 === f.side
                ...
                : 2 === f.side
                ? D.y + 8
                : Math.cos(g.rotation * w) * (D.y - g.getBBox(!1, 0).height / 2));
        ...
        renderGridLine: function(a, c, g) {
          ...
          n ||
            (d.chart.styledMode ||
              ((b.stroke = A), (b["stroke-width"] = h), m && (b.dashstyle = m)),
            f || (b.zIndex = 1),
            a && (c = 0),
            (this.gridLine = n = t
              .path()
              ...
              .add(d.gridGroup)));
          if (n && (g = d.getPlotLinePath(l + v, n.strokeWidth() * g, a, "pass")))
            n[a || this.isNew ? "attr" : "animate"]({ d: g, opacity: c });
        },
          ...
          f &&
            ...
            t &&
              ((this.mark = v = n
                ...
                .add(d.axisGroup)),
              d.chart.styledMode || v.attr({ stroke: m, "stroke-width": h })),
            v[t ? "attr" : "animate"]({
        ...
        renderLabel: function(a, p, g, d) {
          ...
          l &&
            c(h) &&
            ((l.xy = a = this.getLabelPosition(h, a, l, n, f, m, d, v)),
    ...
    var X = (function(a) {
      ...
      a.extend(y.prototype, {
        ...
        init: function(a, q) {
          ...
          b.side =
            q.side || (b.horiz ? (b.opposite ? 0 : 2) : b.opposite ? 1 : 3);
          b.setOptions(q);
          var f = this.options,
            l = f.type;
          ...
          b.crosshair = D(
            f.crosshair,
            k(a.options.tooltip.crosshairs)[e ? 0 : 1],
            !1
          );
          q = b.options.events;
          -1 === a.axes.indexOf(b) &&
            (e ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b),
            a[b.coll].push(b));
          b.series = b.series || [];
          a.inverted &&
            !b.isZAxis &&
                ...
                if (a.isXAxis)
                  (b = e.xData),
                    b.length &&
                      ...
                      l(e) ||
                        e instanceof Date ||
                        ((b = b.filter(l)), (e = h(b)), (k = G(b))),
                      b.length &&
                        ((a.dataMin = Math.min(D(a.dataMin, b[0], e), e)),
                        (a.dataMax = Math.max(D(a.dataMax, b[0], k), k))));
                else if (
                  (e.getExtremes(),
                  (k = e.dataMax),
                  (e = e.dataMin),
                  w(e) &&
                    w(k) &&
                    ((a.dataMin = Math.min(D(a.dataMin, e), e)),
                    (a.dataMax = Math.max(D(a.dataMax, k), k))),
                  w(f) && (a.threshold = f),
        ...
        translate: function(a, q, b, k, f, d) {
          ...
          q
            ? ((a = (a * g + n - t) / c + k), f && (a = e.lin2val(a)))
            : (f && (a = e.val2lin(a)),
              (a = l(k)
                ? g * (a - k) * c + n + g * t + (l(d) ? c * d : 0)
                : void 0));
          return a;
        },
        toPixels: function(a, q) {
          return (
            this.translate(a, !1, !this.horiz, null, !0) + (q ? 0 : this.pos)
          );
        },
        ...
        getPlotLinePath: function(a, q, b, k, f) {
          var e = this,
            ...
            A = function(a, e, q) {
              if (("pass" !== k && a < e) || a > q)
                k ? (a = Math.min(Math.max(e, a), q)) : (h = !0);
              return a;
            };
          ...
          d(this, "getPlotLinePath", y, function(d) {
            ...
            l(f)
              ? e.horiz
                ? ((m = c), (E = C - e.bottom), (t = v = A(t, n, n + e.width)))
                : ((t = n), (v = p - e.right), (m = E = A(m, c, c + e.height)))
              : ((h = !0), (k = !1));
            d.path =
              h && !k
                ? null
                : g.renderer.crispLine(["M", t, m, "L", v, E], q || 1);
          });
          return y.path;
        },
        getLinearTickPositions: function(a, q, b) {
          var e,
            k = r(Math.floor(q / a) * a);
          b = r(Math.ceil(b / a) * a);
          var f = [],
            d;
          r(k + a) === k && (d = 20);
        ...
        getMinorTickPositions: function() {
          ...
          if (g && g / k < a.len / 3)
            if (a.isLog)
              this.paddedTicks.forEach(function(e, q, b) {
                q &&
                  f.push.apply(f, a.getLogTickPositions(k, b[q - 1], b[q], !0));
              });
            else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
              f = f.concat(
                a.getTimeTicks(
                  a.normalizeTimeTickInterval(k),
                  l,
                  d,
                  q.startOfWeek
                )
        ...
        adjustForMinRange: function() {
          ...
          this.isXAxis &&
            ...
            (w(a.min) || w(a.max)
              ...
              : (this.series.forEach(function(a) {
                  n = a.xData;
                  for (l = c = a.xIncrement ? 1 : n.length - 1; 0 < l; l--)
          ...
          b - q < this.minRange &&
            ...
            (f = (t - b + q) / 2),
            (f = [q - f, D(a.min, q - f)]),
            k && (f[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
            (q = G(f)),
            (b = [q + t, D(a.max, q + t)]),
            k && (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
            (b = h(b)),
            b - q < t && ((f[0] = b - t), (f[1] = D(a.min, b - t)), (q = G(f))));
          this.min = q;
          this.max = b;
        },
        getClosest: function() {
          ...
          0 < b.length &&
            ...
            (this.series || []).forEach(function(e) {
              ...
              if (!e.points || e.isDirtyData)
                (a.max = Math.max(a.max, e.xData.length - 1)),
                  e.processData(),
                  e.generatePoints();
              e.data.forEach(function(b, q) {
                ...
                b &&
                  ...
                  void 0 !== b.name &&
                  ((f = a.nameToX(b)),
                  void 0 !== f && f !== b.x && ((b.x = f), (e.xData[q] = f)));
              });
            }));
        },
            ...
            (l = e.getClosest()),
              c
                ...
                : e.series.forEach(function(a) {
                    ...
                    k = Math.max(k, b);
                    e.single ||
                      ((g = Math.max(g, v && f(a) ? 0 : b / 2)),
                      (n = Math.max(n, v && "on" === a ? 0 : b)));
                  }),
              (c = e.ordinalSlope && l ? e.ordinalSlope / l : 1),
              (e.minPointOffset = g *= c),
              (e.pointRangePadding = n *= c),
              (e.pointRange = Math.min(k, b)),
              v && (e.closestPointRange = l);
          a && (e.oldTransA = m);
          e.translationSlope = e.transA = m =
            e.staticScale || e.len / (b + n || 1);
        ...
        setTickInterval: function(e) {
          ...
          G = D(b.userMax, k.max);
          v
            ? ((b.linkedParent = f[b.coll][k.linkedTo]),
              (p = b.linkedParent.getExtremes()),
              (b.min = D(p.min, p.dataMin)),
              (b.max = D(p.max, p.dataMax)),
              k.type !== b.linkedParent.options.type && a.error(11, 1, f))
            : (!x &&
                w(H) &&
                (b.dataMin >= H
                  ? ((p = H), (C = 0))
                  : b.dataMax <= H && ((u = H), (E = 0))),
              (b.min = D(z, p, b.dataMin)),
              (b.max = D(G, u, b.dataMax)));
          g &&
            (b.positiveValuesOnly &&
              !e &&
              0 >= Math.min(b.min, D(b.dataMin, b.min)) &&
              a.error(10, 1, f),
            (b.min = r(b.log2lin(b.min), 15)),
            (b.max = r(b.log2lin(b.max), 15)));
          b.range &&
            w(b.max) &&
            ((b.userMin = b.min = z = Math.max(b.dataMin, b.minFromRange())),
            (b.userMax = G = b.max),
            (b.range = null));
          d(b, "foundExtremes");
          b.beforePadding && b.beforePadding();
          b.adjustForMinRange();
          !(A || b.axisPointRange || b.usePercentage || v) &&
            w(b.min) &&
            w(b.max) &&
            (f = b.max - b.min) &&
            (!w(z) && C && (b.min -= f * C), !w(G) && E && (b.max += f * E));
          l(k.softMin) && !l(b.userMin) && (b.min = Math.min(b.min, k.softMin));
          l(k.softMax) && !l(b.userMax) && (b.max = Math.max(b.max, k.softMax));
          l(k.floor) &&
            (b.min = Math.min(Math.max(b.min, k.floor), Number.MAX_VALUE));
          l(k.ceiling) &&
            (b.max = Math.max(
              Math.min(b.max, k.ceiling),
              D(b.userMax, -Number.MAX_VALUE)
            ));
          x &&
            w(b.dataMin) &&
            ((H = H || 0),
            !w(z) && b.min < H && b.dataMin >= H
              ? (b.min = H)
              : !w(G) && b.max > H && b.dataMax <= H && (b.max = H));
          b.tickInterval =
            b.min === b.max || void 0 === b.min || void 0 === b.max
              ? 1
              : v && !h && y === b.linkedParent.options.tickPixelInterval
              ? (h = b.linkedParent.tickInterval)
              : D(
                  h,
                  this.tickAmount
                    ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1)
                    : void 0,
                  A ? 1 : ((b.max - b.min) * y) / Math.max(b.len, y)
                );
          m &&
            !e &&
          ...
          !b &&
            ...
            (this.max - this.min) / this.tickInterval >
              ...
              : (b = this.isDatetimeAxis
                  ? this.getTimeTicks(
                      this.normalizeTimeTickInterval(this.tickInterval, e.units),
                      this.min,
                      this.max,
                      e.startOfWeek,
                      this.ordinalPositions,
        ...
        zoom: function(a, b) {
          ...
          d(this, "zoom", a, function(a) {
            var b = a.newMin,
              f = a.newMax;
            if (b !== this.min || f !== this.max)
              this.allowZoomOutside ||
                (w(e) && (b < l && (b = l), b > q && (b = q)),
                w(k) && (f < l && (f = l), f > q && (f = q))),
                (this.displayBtn = void 0 !== b || void 0 !== f),
                this.setExtremes(b, f, !1, void 0, { trigger: "zoom" });
            a.zoomed = !0;
          });
          return a.zoomed;
        },
        setAxisSize: function() {
          var e = this.chart,
            ...
            d = (this.width = Math.round(
              a.relativeLength(D(b.width, e.plotWidth - k[3] + k[1]), e.plotWidth)
            )),
            l = (this.height = Math.round(
              a.relativeLength(
                D(b.height, e.plotHeight - k[0] + k[2]),
                e.plotHeight
              )
            )),
            g = (this.top = Math.round(
              a.relativeLength(
                D(b.top, e.plotTop + k[0]),
                e.plotHeight,
                e.plotTop
              )
            )),
        ...
        unsquish: function() {
          ...
          b
            ? (m =
                ...
                (w(g)
                  ? [g]
                  : d < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
              m.forEach(function(a) {
                var b;
                if (a === g || (a && -90 <= a && 90 >= a))
                  (c = E(Math.abs(n.h / Math.sin(x * a)))),
                    (b = c + Math.abs(a / 360)),
                    b < t && ((t = b), (l = a), (f = c));
              })
            : a.step || (f = E(n.h));
        ...
        getSlotWidth: function(a) {
          ...
          return (
            ...
            (!e &&
              ((k.style && parseInt(k.style.width, 10)) ||
                (d && d - b.spacing[3]) ||
                0.33 * b.chartWidth))
          );
        },
        renderUnsquish: function() {
          ...
          k.forEach(function(a) {
            (a = d[a]) &&
              a.label &&
              a.label.textPxLength > h &&
              (h = a.label.textPxLength);
          });
          ...
          if (this.autoRotation)
            ...
            for (p = "clip", t = k.length; !n && t--; )
              if (((y = k[t]), (y = d[y].label)))
                y.styles && "ellipsis" === y.styles.textOverflow
                  ? y.css({ textOverflow: "clip" })
                  : y.textPxLength > c && y.css({ width: c + "px" }),
                  y.getBBox().height > this.len / k.length - (v.h - v.f) &&
                    (y.specificTextOverflow = "ellipsis");
          m.rotation &&
            ((C = h > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : h),
            E || (p = "ellipsis"));
          if (
            ...
            b &&
              ...
              a.shortenLabel
                ...
                : C &&
                  !e &&
                  "nowrap" !== g.whiteSpace &&
                  (C < b.textPxLength || "SPAN" === b.element.tagName)
                ? ((k.width = C),
                  E || (k.textOverflow = b.specificTextOverflow || p),
                  b.css(k))
                : b.styles &&
                  b.styles.width &&
                  !k.width &&
        ...
        addTitle: function(a) {
          ...
          this.axisTitle ||
            ...
            l || this.axisTitle.css(v(f.style)),
        ...
        getOffset: function() {
          ...
          h &&
            ...
            v &&
              !1 !== h.reserveSpace &&
              ((a.titleOffset = E = a.axisTitle.getBBox()[
                n ? "height" : "width"
              ]),
              (C = h.offset),
              (p = w(C) ? 0 : D(h.margin, n ? 5 : 10))));
          a.renderLine();
          ...
          a.getMaxLabelDimensions &&
            (a.maxLabelDimensions = a.getMaxLabelDimensions(g, l));
          n = this.tickSize("tick");
          r[c] = Math.max(
            r[c],
            a.axisTitleMargin + E + x * a.offset,
            p,
            m && l.length && n ? n[0] + x * a.offset : 0
          );
        ...
        getLinePath: function(a) {
          ...
          return b.renderer.crispLine(
            [
              ...
              f ? k : this.top,
              "L",
              f ? b.chartWidth - this.right : d,
              f ? k : b.chartHeight - this.bottom
            ],
            a
          );
        },
        ...
        renderTick: function(a, b) {
          ...
          if (!e || (a >= this.min && a <= this.max))
            k[a] || (k[a] = new C(this, a)),
              f && k[a].isNew && k[a].render(b, !0, -1),
              k[a].render(b);
        },
        render: function() {
          var b = this,
          ...
          if (b.hasData() || n)
            b.minorTickInterval &&
              ...
              c.length &&
                ...
                A &&
                  (0 === b.min || b.single) &&
                  (m[-1] || (m[-1] = new C(b, -1, null, !0)), m[-1].render(-1))),
              y &&
                c.forEach(function(e, f) {
                  ...
                  0 === f % 2 &&
                    e < b.max &&
                    w <= b.max + (k.polar ? -A : A) &&
                    (p[e] || (p[e] = new a.PlotLineOrBand(b)),
                    (u = e + A),
                    (p[e].options = {
          ...
          t &&
            ...
            l(f.y)
              ? (t[t.isNew ? "attr" : "animate"](f), (t.isNew = !1))
    ...
    (function(a) {
      ...
      z.prototype.normalizeTimeTickInterval = function(a, r) {
        ...
        for (
          ...
          (w = h[r[0]]),
          (x = r[1]),
          c[p + 1] && a <= (w * x[x.length - 1] + h[c[p + 1][0]]) / 2);
          p++
        );
        w === h.year && a < 5 * w && (x = [1, 2, 5]);
    ...
    (function(a) {
      ...
      z.prototype.getLogTickPositions = function(a, r, u, w) {
        ...
        if (0.5 <= a)
          (a = Math.round(a)), (g = this.getLinearTickPositions(a, r, u));
        else if (0.08 <= a)
          for (
            var p = Math.floor(r),
              d,
            ...
            for (m = c.length, d = 0; d < m && !l; d++)
              (n = this.log2lin(this.lin2log(p) * c[d])),
                n > r && (!w || b <= u) && void 0 !== b && g.push(b),
                b > u && (l = !0),
                (b = n);
        else
          (r = this.lin2log(r)),
            (u = this.lin2log(u)),
            (a = w ? this.getMinorTickInterval() : c.tickInterval),
            (a = h(
              "auto" === a ? null : a,
              this._minorAutoInterval,
              ((c.tickPixelInterval / (w ? 5 : 1)) * (u - r)) /
                ((w ? p / this.tickPositions.length : p) || 1)
            )),
            (a = G(a, null, F(a))),
            (g = this.getLinearTickPositions(a, r, u).map(this.log2lin)),
    ...
    (function(a, z) {
      ...
      a.PlotLineOrBand.prototype = {
        render: function() {
          ...
          var c = this,
            ...
            A = {
              class:
                "highcharts-plot-" + (v ? "band " : "line ") + (d.className || "")
            },
            y = {},
            e = p.chart.renderer,
            q = v ? "bands" : "lines";
          ...
          y.zIndex = E;
          q += "-" + E;
          (k = p.plotLinesAndBandsGroups[q]) ||
            (p.plotLinesAndBandsGroups[q] = k = e
              .g("plot-" + q)
              .attr(y)
              .add());
          D &&
      ...
      a.extend(z.prototype, {
        getPlotBandPath: function(a, c) {
          ...
          if (d && g)
            for (
              a && ((l = d.toString() === g.toString()), (b = 0)), a = 0;
              a < d.length;
              a += 6
            )
              n && g[a + 1] === d[a + 1]
    ...
    (function(a) {
      ...
      a.Tooltip.prototype = {
        init: function(a, g) {
          ...
          this.outside = g.outside && !this.split;
        },
        ...
        getLabel: function() {
          ...
          this.label ||
            (this.outside &&
              ...
              (this.renderer = g = new a.Renderer(n, 0, 0))),
            this.split
              ? (this.label = g.g("tooltip"))
              : ((this.label = g
                  .label(
                    "",
                    0,
        ...
        getAnchor: function(a, c) {
          ...
          this.followPointer && c
            ? (void 0 === c.chartX && (c = g.normalize(c)),
              (a = [c.chartX - d.plotLeft, c.chartY - b]))
            : a[0].tooltipPos
            ? (a = a[0].tooltipPos)
        ...
        getPosition: function(a, c, d) {
          var g = this.chart,
            ...
            h = v
              ? Math.max(
                  z.body.scrollHeight,
                  z.documentElement.scrollHeight,
                  z.body.offsetHeight,
                  z.documentElement.offsetHeight,
            ...
            A = [
              ...
              h,
              c,
              (v ? p.top - n : 0) + d.plotY + g.plotTop,
              v ? 0 : g.plotTop,
              v ? h : g.plotTop + g.plotHeight
            ],
            k = [
              "x",
              t,
              a,
              (v ? p.left - n : 0) + d.plotX + g.plotLeft,
              v ? 0 : g.plotLeft,
              v ? t : g.plotLeft + g.plotWidth
            ],
            ...
            y = function(a, e, k, f) {
              ...
              f < n || f > e - n
                ? (d = !1)
                : (b[a] = f < k / 2 ? 1 : f > e - k / 2 ? e - k - 2 : f - k / 2);
              return d;
            },
            e = function(a) {
              var b = A;
        ...
        refresh: function(c, g) {
          ...
          m.enabled &&
            ...
            (l = this.getAnchor(b, g)),
            (g = l[0]),
            (n = l[1]),
            !f || (b.series && b.series.noSharedTooltip)
              ? (f = b.getLabelConfig())
            ...
            !1 === f
              ...
              : ((d = this.getLabel()),
                ...
                this.split
                  ? this.renderSplit(f, u(c))
                  : ((m.style.width && !h) ||
                      d.css({ width: this.chart.spacingBox.width }),
                    d.attr({ text: f && f.join ? f.join("") : f }),
                    d
                      .removeClass(/highcharts-color-[\d]+/g)
                      .addClass(
                        "highcharts-color-" + r(b.colorIndex, t.colorIndex)
                      ),
                    h ||
                      d.attr({
        ...
        renderSplit: function(c, g) {
          ...
          c.slice(0, g.length + 1).forEach(function(a, k) {
            if (!1 !== a && "" !== a) {
              ...
              C ||
                ((C = { padding: f.padding, r: f.borderRadius }),
                n.styledMode ||
                  ((C.fill = f.backgroundColor),
                  (C.stroke = f.borderColor || k.color || y.color || "#333333"),
                  (C["stroke-width"] = f.borderWidth)),
                (c.tt = C = b
                  .label(
                    null,
                    null,
                    null,
                    (k.isHeader ? f.headerShape : f.shape) || "callout",
                    null,
                    null,
                    f.useHTML
                  )
              ...
              k.isHeader
                ? ((v = a.height),
                  n.xAxis[0].opposite && ((t = !0), (p -= v)),
                  (y = Math.max(
                    0,
                    Math.min(
                      k.plotX + n.plotLeft - y / 2,
                      n.chartWidth +
                        (n.scrollablePixels
                          ? n.scrollablePixels - n.marginRight
                          : 0) -
                        y
                    )
                  )))
                : (y = k.plotX + n.plotLeft - r(f.distance, 16) - y);
              0 > y && (l = !1);
              a =
                (k.series && k.series.yAxis && k.series.yAxis.pos) +
                (k.plotY || 0);
              a -= p;
              k.isHeader && (a = t ? -v : n.plotHeight + v);
              m.push({
                target: a,
                rank: k.isHeader ? 1 : 0,
          ...
          m.forEach(function(a) {
            ...
            a.tt.attr({
              ...
              x:
                l || b.isHeader || f.positioner
                  ? a.x
                  : b.plotX + n.plotLeft + d.distance,
              y: a.pos + p,
              anchorX: b.isHeader ? b.plotX + n.plotLeft : b.plotX + c.xAxis.pos,
              anchorY: b.isHeader
                ? n.plotTop + n.plotHeight / 2
                : b.plotY + c.yAxis.pos
            });
          });
        },
        updatePosition: function(a) {
          ...
          this.outside &&
            ...
            (n += c.pointer.chartPosition.left - m.x),
            (a += c.pointer.chartPosition.top - m.y));
          this.move(Math.round(m.x), Math.round(m.y || 0), n, a);
        },
        getDateFormat: function(a, c, d, m) {
          ...
          for (f in x) {
            ...
            if (v[f] && b.substr(v[f]) !== "01-01 00:00:00.000".substr(v[f]))
              break;
            "week" !== f && (t = f);
          }
        ...
        getXDateFormat: function(a, c, d) {
          ...
          return (
            (g ? this.getDateFormat(g, a.x, d.options.startOfWeek, c) : c.day) ||
            c.year
          );
        },
        tooltipFooterHeaderFormatter: function(c, g) {
          ...
          a.fireEvent(this, "headerFormatter", g, function(a) {
            ...
            f &&
              b &&
              ((c.point && c.point.tooltipDateKeys) || ["key"]).forEach(function(
                a
              ) {
    ...
    (function(a) {
      ...
      a.Pointer.prototype = {
        ...
        getChartCoordinatesFromPoint: function(a, b) {
          ...
          if (d && f)
            return b
              ? { chartX: d.len + d.pos - l, chartY: f.len + f.pos - a.plotY }
        ...
        runPointActions: function(b, f) {
          ...
          if (g && (g !== d.hoverPoint || (c && c.isHidden))) {
            ...
            f &&
              ...
              !c.isHidden &&
              ((g = c.getAnchor([{}], b)),
              c.updatePosition({ plotX: g[0], plotY: g[1] }));
          this.unDocMouseMove ||
        ...
        scaleGroups: function(a, b) {
          ...
          f.series.forEach(function(c) {
            ...
            c.xAxis &&
              ...
              (c.group.attr(d),
              c.markerGroup &&
                (c.markerGroup.attr(d),
                c.markerGroup.clip(b ? f.clipRect : null)),
              c.dataLabelsGroup && c.dataLabelsGroup.attr(d));
          });
        ...
        drag: function(a) {
          ...
          (q && q.touch) ||
            ...
            (this.hasDragged = Math.sqrt(
              Math.pow(p - c, 2) + Math.pow(r - l, 2)
            )),
            10 < this.hasDragged &&
              ((e = b.isInsidePlot(p - k, r - m)),
              ...
              q &&
                g &&
                ((c -= p),
                q.attr({ width: Math.abs(c), x: (0 < c ? 0 : c) + p })),
              q &&
                n &&
                ((c = l - r),
                q.attr({ height: Math.abs(c), y: (0 < c ? 0 : c) + r })),
            ...
            if (this.hasDragged || l)
              d.axes.forEach(function(e) {
                if (
                  e.zoomEnabled &&
                  r(e.min) &&
                  (l || b[{ xAxis: "zoomX", yAxis: "zoomY" }[e.coll]])
                ) {
                  var f = e.horiz,
        ...
        onContainerClick: function(a) {
          ...
          b.cancelClick ||
            (d && this.inClass(a.target, "highcharts-tracker")
              ? (x(d.series, "click", u(a, { point: d })),
                b.hoverPoint && d.firePointEvent("click", a))
              : (u(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - c, a.chartY - l) && x(b, "click", a)));
        },
        setDOMEvents: function() {
          ...
          a.unbindDocumentMouseUp ||
            (a.unbindDocumentMouseUp = z(d, "mouseup", b.onDocumentMouseUp));
          a.hasTouch &&
    ...
    (function(a) {
      ...
      F(a.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, h, u, w, x, p, g, d) {
          ...
          h < k.min
            ? ((h = k.min), (L = !0))
            : h + t > k.max && ((h = k.max - t), (L = !0));
          L
            ? ((y -= 0.8 * (y - g[n][0])), E || (q -= 0.8 * (q - g[n][1])), u())
            : (g[n] = [y, q]);
          A || ((p[n] = r - v), (p[f] = t));
          p = A ? 1 / D : D;
          x[f] = t;
        ...
        pinch: function(a) {
          var c = this,
            ...
            b =
              1 === p &&
              ((c.inClass(a.target, "highcharts-tracker") && u.runTrackerClick) ||
                c.runChartClick),
            l = {};
          1 < p && (c.initiated = !0);
          ...
          "touchstart" === a.type
            ? ([].forEach.call(x, function(a, b) {
                w[b] = { chartX: a.chartX, chartY: a.chartY };
              }),
              (g.x = [w[0].chartX, w[1] && w[1].chartX]),
              (g.y = [w[0].chartY, w[1] && w[1].chartY]),
              ...
              (c.res = !0))
            : c.followTouchMove && 1 === p
            ? this.runPointActions(c.normalize(a))
            : w.length &&
              (m ||
                (c.selectionMarker = m = F({ destroy: G, touch: !0 }, u.plotBox)),
              c.pinchTranslate(w, x, n, m, l, g),
              (c.hasPinched = d),
              c.scaleGroups(n, l),
        ...
        touch: function(c, r) {
          ...
          1 === c.touches.length
            ? ((c = this.normalize(c)),
              (x = u.isInsidePlot(c.chartX - u.plotLeft, c.chartY - u.plotTop)) &&
              !u.openMenu
                ? (r && this.runPointActions(c),
                  "touchmove" === c.type &&
                    ((r = this.pinchDown),
                    (w = r[0]
                      ? 4 <=
                        Math.sqrt(
                          Math.pow(r[0].chartX - c.chartX, 2) +
                            Math.pow(r[0].chartY - c.chartY, 2)
                        )
                      : !1)),
                  h(w, !0) && this.pinch(c))
                : r && this.reset())
    ...
    (function(a) {
      ...
      a.Legend.prototype = {
        ...
        colorizeItem: function(a, b) {
          ...
          if (!this.chart.styledMode) {
            ...
            n &&
              (p &&
                n.isMarker &&
                ((k = a.pointAttribs()), b || (k.stroke = k.fill = m)),
              n.attr(k));
          }
          ...
          a &&
            ...
            this.allItems.forEach(function(c) {
              var g = c.checkbox,
                l;
              g &&
                ((l = b + f + g.y + (this.scrollOffset || 0) + 3),
                F(g, {
                  left: a.translateX + c.checkboxOffset + g.x - 20 + "px",
                  top: l + "px",
                  display:
                    this.proximate || (l > b - 6 && l < b + d - 6) ? "" : "none"
                }));
            }, this));
        },
        ...
        setText: function(d) {
          ...
          d.legendItem.attr({
            text: b.labelFormat
              ? a.format(b.labelFormat, d, this.chart.time)
        ...
        renderItem: function(a) {
          ...
          E ||
            ...
            (a.legendItem = E = d.text(
              "",
              k ? c + g : -g,
              this.baseline || 0,
              q
            )),
            b.styledMode || E.css(w(a.visible ? n : m)),
            E.attr({ align: k ? "left" : "right", zIndex: 2 }).add(a.legendGroup),
            this.baseline ||
            ...
            this.setItemEvents && this.setItemEvents(a, E, q),
          ...
          a.itemWidth = a.checkboxOffset =
            f.itemWidth || a.legendItemWidth || b.width + h;
        ...
        layoutItem: function(a) {
          ...
          f &&
            this.itemX - d + b > h &&
            ((this.itemX = d),
            (this.itemY += n + this.lastLineHeight + g),
          ...
          f
            ? (this.itemX += b)
            : ((this.itemY += n + c + g), (this.lastLineHeight = c));
          this.offsetWidth =
            this.widthOption ||
            Math.max(
              (f ? this.itemX - d - (a.checkbox ? 0 : m) : b) + d,
              this.offsetWidth
            );
        },
        getAllItems: function() {
          ...
          this.chart.series.forEach(function(b) {
            var d = b && b.options;
            b &&
              x(d.showInLegend, h(d.linkedTo) ? !1 : void 0, !0) &&
              (a = a.concat(
        ...
        proximatePositions: function() {
          ...
          this.allItems.forEach(function(f) {
            ...
            f.xAxis &&
              ...
              (g = a.find(g ? f.points : f.points.slice(0).reverse(), function(
                b
              ) {
                return a.isNumber(b.plotY);
              })),
              (l = f.legendGroup.getBBox().height),
              b.push({
                target: f.visible
                  ? (g ? g.plotY : f.xAxis.height) - 0.3 * l
                  : d.plotHeight,
                size: l,
                item: f
              }));
        ...
        render: function() {
          ...
          this.widthOption = a.relativeLength(r.width, d.spacingBox.width - A);
          ...
          m &&
            ...
            /(lth|ct|rth)/.test(this.getAlignment()) &&
              (b = w(b, { y: b.y + d.titleOffset + d.options.title.margin })),
            c.align(
              w(r, {
                width: f,
                height: h,
        ...
        handleOverflow: function(a) {
          ...
          q.length = 0;
          a > g && !1 !== E.enabled
            ? ((this.clipHeight = h = Math.max(g - 20 - this.titleHeight - m, 0)),
              ...
              k ||
                ((k = b.clipRect = f.clipRect(0, m, 9999, 0)),
              ...
              e ||
                ...
                d.styledMode || this.pager.css(E.style),
                this.pager.add(e),
                (this.down = f
      ...
      a.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
          ...
          d &&
            !1 !== d.enabled &&
            f &&
            ((b = Math.min(x(d.radius, g), g)),
            0 === this.symbol.indexOf("url") &&
              ((d = w(d, { width: c, height: c })), (b = 0)),
            (this.legendSymbol = d = m
              .symbol(this.symbol, f / 2 - b, a - b, 2 * b, 2 * b, d)
              .addClass("highcharts-point")
              .add(n)),
            (d.isMarker = !0));
        }
      };
      (/Trident\/7\.0/.test(d.navigator.userAgent) || r) &&
      ...
      m(T.prototype, {
        ...
        init: function(e, d) {
          ...
          b(this, "init", { args: arguments }, function() {
            ...
            this.series = [];
            this.time =
              e.time && Object.keys(e.time).length ? new a.Time(e.time) : a.time;
        ...
        initSeries: function(b) {
          ...
          (d = e[b.type || d.type || d.defaultSeriesType]) ||
            a.error(17, !0, this);
          d = new d();
          d.init(this, b);
          return d;
          ...
          k.forEach(function(a) {
            a.isDirty &&
              ("point" === a.options.legendType
                ...
                : g && (g.labelFormatter || g.labelFormat) && (q = !0));
        ...
        setTitle: function(a, b, e) {
          ...
          c = k.title = D(
            !f && {
              style: { color: "#333333", fontSize: k.isStock ? "16px" : "18px" }
            },
            k.title,
            a
          );
        ...
        layOutTitles: function(a) {
          ...
          ["title", "subtitle"].forEach(function(a) {
            ...
            var c;
            e &&
              (this.styledMode || (c = f.style.fontSize),
              (c = d.fontMetrics(c, e).b),
              e
                .css({ width: (f.width || k.width + f.widthAdjust) + "px" })
                .align(m({ y: a + c }, f), !1, "spacingBox"),
              f.floating ||
                f.verticalAlign ||
                (b = Math.ceil(b + e.getBBox(f.useHTML).height)));
          }, this);
        ...
        getChartSize: function() {
          var b = this.options.chart,
            ...
            b = b.height,
            k = this.renderTo;
          d(e) || (this.containerWidth = a.getStyle(k, "width"));
        ...
        temporaryDisplay: function(b) {
          ...
          if (b)
            for (; e && e.style; )
              e.hcOrigStyle && (a.css(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached &&
        ...
        getContainer: function() {
          ...
          this.renderer = new (a[k.renderer] || a.Renderer)(
            e,
            f,
            q,
            null,
        ...
        getMargins: function(a) {
          ...
          f &&
            ...
            (this.plotTop = Math.max(
              this.plotTop,
              f + this.options.title.margin + e[0]
            ));
        ...
        reflow: function(b) {
          ...
          if (!g && !e.isPrinting && q && k && (f === K || f === c)) {
            if (q !== e.containerWidth || k !== e.containerHeight)
        ...
        setReflow: function(a) {
          ...
          !1 === a || this.unbindReflow
            ...
            : ((this.unbindReflow = z(K, "resize", function(a) {
                b.reflow(a);
              })),
        ...
        setSize: function(e, k, d) {
          ...
          f.setChartSize(!0);
          c.setSize(f.chartWidth, f.chartHeight, d);
          f.axes.forEach(function(a) {
            a.isDirty = !0;
            a.setScale();
          });
        ...
        setChartSize: function(a) {
          ...
          this.plotHeight = h = Math.max(
            0,
            Math.round(f - m - this.marginBottom)
          );
          ...
          this.clipBox = {
            ...
            height: Math.max(
              0,
              Math.floor(this.plotSizeY - Math.max(d, q[2]) / 2 - k)
            )
          };
          a ||
        ...
        drawChartBox: function() {
          ...
          if (l) q = C = f.strokeWidth();
            ...
            n = { fill: n || "none" };
            if (q || f["stroke-width"])
              (n.stroke = a.borderColor), (n["stroke-width"] = q);
          ...
          c[w](r);
          l ||
            (c.attr({ fill: h || "none" }).shadow(a.plotShadow),
            E &&
              (m
                ? m.animate(r)
                : (this.plotBGImage = e.image(E, t, p, y, v).add())));
          A
            ? A.animate({ width: u.width, height: u.height })
        ...
        linkSeries: function() {
          ...
          e.forEach(function(b) {
            ...
            v(e) &&
              ...
              (b.linkedParent = e),
              (b.visible = E(b.options.visible, e.options.visible, b.visible)));
          });
        ...
        optionsToObject: function(d) {
          ...
          if (u(d) || null === d) c[l[0]] = d;
            ...
            for (
              ...
              d.length > f &&
              ((g = typeof d[0]),
              "string" === g ? (c.name = d[0]) : "number" === g && (c.x = d[0]),
              h++);
              t < f;
              ...
              (b && void 0 === d[h]) ||
                (0 < l[t].indexOf(".")
                  ? a.Point.prototype.setNestedProperty(c, d[h], l[t])
                  : (c[l[t]] = d[h])),
                h++,
                t++;
          else
            "object" === typeof d &&
              ((c = d),
              d.dataLabels && (g._hasPointLabels = !0),
              d.marker && (g._hasPointMarkers = !0));
          return c;
        },
        ...
        },
        {
          ...
          setOptions: function(a) {
            ...
            (!d.negativeColor && !d.negativeFillColor) ||
              ...
              l ||
                ((k.color = d.negativeColor),
                (k.fillColor = d.negativeFillColor)),
              a.push(k));
            a.length &&
              w(a[a.length - 1].value) &&
              a.push(l ? {} : { color: this.color, fillColor: this.fillColor });
            ...
            b.forEach(function(b) {
              ...
              if ((c = c.id) || m(h))
                c && (q = (q = this.chart.get(c)) && q.index),
                  void 0 === q && m(h) && (q = this.xData.indexOf(h, g)),
                  -1 === q || void 0 === q || k[q].touched
                    ? f.push(b)
                    : b !== d.data[q]
                    ? (k[q].update(b, !1, null, !1),
                      (k[q].touched = !0),
                      l && (g = q + 1))
                    : k[q] && (k[q].touched = !0),
                  (e = !0);
            ...
            if (!H) {
              ...
              if (y && t > y) {
                ...
                for (g = 0; g < t; g++)
                  void 0 !== b[g] &&
                    ((v = { series: e }),
                    e.pointClass.prototype.applyOptions.apply(v, [b[g]]),
                    e.updateParallelArrays(v, g));
          ...
          processData: function(b) {
            ...
            var n = this.getExtremesFromAll || h.getExtremesFromAll,
              ...
              r,
              A;
            if (t && !this.isDirty && !l.isDirty && !this.yAxis.isDirty && !b)
              return !1;
            l && ((b = l.getExtremes()), (r = b.min), (A = b.max));
            t &&
              this.sorted &&
              !n &&
              (!m || f > m || this.forceCrop) &&
              (d[f - 1] < r || d[0] > A
                ? ((d = []), (k = []))
                : this.yData &&
                  (d[0] < r || d[f - 1] > A) &&
                  ((e = this.cropData(this.xData, this.yData, r, A)),
                  (d = e.xData),
                  (k = e.yData),
                  (e = e.start),
                  (c = !0)));
            for (m = d.length || 1; --m; )
              (f = p ? h(d[m]) - h(d[m - 1]) : d[m] - d[m - 1]),
                0 < f && (void 0 === g || f < g)
                  ? (g = f)
                  : 0 > f && v && (a.error(15, !1, this.chart), (v = !1));
            this.cropped = c;
            this.cropStart = e;
          ...
          generatePoints: function() {
            ...
            for (u = 0; u < m; u++)
              (n = h + u),
                v
                  ? ((r = new l().init(this, [e[u]].concat(t(c[u])))),
                    (r.dataGroup = this.groupMap[u]),
                    r.dataGroup.options &&
                      ((r.options = r.dataGroup.options),
                      p(r, r.dataGroup.options),
                      delete r.dataLabels))
                  : (r = d[n]) ||
                    void 0 === b[n] ||
                    (d[n] = r = new l().init(this, b[n], e[u])),
                r && ((r.index = n), (A[u] = r));
            this.options.keys = a;
            if (d && (m !== (f = d.length) || v))
              for (u = 0; u < f; u++)
          ...
          getExtremes: function(a) {
            ...
            for (A = 0; A < f; A++)
              if (
                ...
                (t =
                  (m(r, !0) || d(r)) &&
                  (!b.positiveValuesOnly || r.length || 0 < r)),
                (p =
          ...
          translate: function() {
            ...
            for (t = 0; t < h; t++) {
              ...
              var M =
                  b &&
                  e.stacks[
                    (this.negStacks && Q < (A ? 0 : r) ? "-" : "") + this.stackKey
                  ],
                V;
              ...
              F.plotX = u = c(
                Math.min(
                  Math.max(
                    -1e5,
                    d.translate(I, 0, 0, 0, 1, p, "flags" === this.type)
                  ),
                  1e5
                )
              );
              b &&
                ...
                (D = Q[0]),
                (Q = Q[1]),
                D === A && H.key === M[I].base && (D = f(m(r) && r, e.min)),
              ...
              F.plotY = D =
                "number" === typeof Q && Infinity !== Q
                  ? Math.min(Math.max(-1e5, e.translate(Q, 0, 1, 0, 1)), 1e5)
                  : void 0;
              F.isInside =
                void 0 !== D && 0 <= D && D <= e.len && 0 <= u && u <= d.len;
              F.clientX = v ? c(d.translate(I, 0, 0, 0, 1, p)) : u;
              F.negative = F[z] < (a[z + "Threshold"] || r || 0);
              F.category = l && void 0 !== l[F.x] ? l[F.x] : F.x;
              F.isNull ||
                (void 0 !== x && (G = Math.min(G, Math.abs(u - x))), (x = u));
          ...
          setClip: function(a) {
            ...
            !1 !== d.clip &&
              (this.group.clip(a || k ? l : b.clipRect),
          ...
          animate: function(a) {
            ...
            a
              ...
              : ((f = this.sharedClipKey),
                (a = b[f]) && a.animate({ width: b.plotSizeX, x: 0 }, d),
                b[f + "m"] &&
                  b[f + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, d),
                (this.animate = null));
          },
            ...
            if (!1 !== l.enabled || this._hasPointMarkers)
              for (d = 0; d < a.length; d++)
                (c = a[d]),
                  ...
                  (m = c.marker || {}),
                  (h = !!c.marker),
                  (e = (v && void 0 === m.enabled) || m.enabled),
                  (n = !1 !== c.isInside),
                  e && !c.isNull
                    ? ((e = f(m.symbol, this.symbol)),
                      (p = this.markerAttribs(c, c.selected && "select")),
                      g
                        ? g[n ? "show" : "hide"](!0).animate(p)
                        : n &&
                          (0 < p.width || c.hasImage) &&
                          (c.graphic = g = b.renderer
                            .symbol(e, p.x, p.y, p.width, p.height, h ? m : l)
                            .add(t)),
                      g &&
                        !b.styledMode &&
                        g.attr(this.pointAttribs(c, c.selected && "select")),
          ...
          pointAttribs: function(a, b) {
            ...
            b &&
              ...
              (c = f(
                b.lineWidth,
                d.lineWidth,
                c + f(b.lineWidthPlus, d.lineWidthPlus, 0)
              )),
          ...
          destroy: function() {
            ...
            (b.axisTypes || []).forEach(function(a) {
              (h = b[a]) &&
                h.series &&
                (x(h.series, b), (h.isDirty = h.forceRedraw = !0));
            });
          ...
          drawGraph: function() {
            ...
            e.forEach(function(e, c) {
              var k = e[0],
                g = a[k];
              g
                ? ((g.endX = a.preventGraphAnimation ? null : d.xMap),
                  g.animate({ d: d }))
                : d.length &&
                  ...
                  f ||
                    ...
                    (g = a[k].attr(g).shadow(2 > c && b.shadow))));
          ...
          applyZones: function() {
            ...
            c.length &&
              ...
              c.forEach(function(c, k) {
                ...
                g = Math.min(
                  Math.max(Math.round(p.toPixels(f(c.value, v.max), !0) || 0), 0),
                  t
                );
                ...
                x = Math.max(e, g);
                p.isXAxis
                  ? ((m = { x: A ? x : D, y: 0, width: w, height: t }),
                    u || (m.x = b.plotHeight - m.x))
                  : ((m = { x: 0, y: A ? x : D, width: t, height: w }),
                    u && (m.y = b.plotWidth - m.y));
                A &&
                  d.isVML &&
                  (m = p.isXAxis
                    ? { x: 0, y: r ? D : x, height: m.width, width: b.chartWidth }
                    : {
                ...
                l[k]
                  ? l[k].animate(m)
                  : ((l[k] = d.clipRect(m)),
                    h && a["zone-graph-" + k].clip(l[k]),
                    n && a["zone-area-" + k].clip(l[k]));
                H = c.value > v.max;
          ...
          searchKDTree: function(a, b, d) {
            function c(a, b, d, l) {
              ...
              q = 0 > h ? "left" : "right";
              n = 0 > h ? "right" : "left";
              b[q] && ((q = c(a, b[q], d + 1, l)), (t = q[g] < t[g] ? q : m));
              b[n] &&
                Math.sqrt(h * h) < t[g] &&
                ((a = c(a, b[n], d + 1, l)), (t = a[g] < t[g] ? a : t));
              return t;
            }
            var e = this,
      ...
      a.StackItem.prototype = {
        ...
        setOffset: function(a, c) {
          ...
          (c = this.label) &&
            ...
            (d = c.alignAttr),
            c[
              !1 === this.options.crop || g.isInsidePlot(d.x, d.y)
                ? "show"
                : "hide"
            ](!0));
        },
      ...
      F.prototype.getStacks = function() {
        ...
        a.series.forEach(function(c) {
          !c.options.stacking ||
            ...
            (c.stackKey = c.type + w(c.options.stack, ""));
        });
      };
      ...
      x.prototype.setStackedPoints = function() {
        if (
          ...
          for (q = 0; q < m; q++)
            (x = c[q]),
              (z = g[q]),
              (E = this.getStackIndicator(E, x, this.index)),
              (e = E.key),
              (y = (C = r && z < (l ? 0 : b)) ? t : v),
              A[y] || (A[y] = {}),
              A[y][x] ||
                (k[y] && k[y][x]
                  ? ((A[y][x] = k[y][x]), (A[y][x].total = null))
                  : (A[y][x] = new a.StackItem(
                      u,
              ...
              (y = A[y][x]),
              null !== z
                ? ((y.points[e] = y.points[this.index] = [w(y.cumulative, l)]),
                  h(y.cumulative) || (y.base = e),
                  (y.touched = u.stacksTouched),
                  0 < E.index &&
                    !1 === this.singleStacks &&
                    (y.points[e][0] = y.points[this.index + "," + x + ",0"][0]))
                : (y.points[e] = y.points[this.index] = null),
              "percent" === n
                ? ((C = C ? v : t),
                  r && A[C] && A[C][x]
                    ? ((C = A[C][x]),
                      (y.total = C.total =
                        Math.max(C.total, y.total) + Math.abs(z) || 0))
                    : (y.total = G(y.total + (Math.abs(z) || 0))))
                : (y.total = G(y.total + (z || 0))),
              (y.cumulative = w(y.cumulative, l) + (z || 0)),
              null !== z &&
                (y.points[e].push(y.cumulative), (d[q] = y.cumulative));
    ...
    (function(a) {
      ...
      a.cleanRecursively = function(c, f) {
        ...
        b(c, function(b, g) {
          if (d(c[g], !0) && f[g])
            (b = a.cleanRecursively(c[g], f[g])),
              Object.keys(b).length && (k[g] = b);
      ...
      x(h.prototype, {
        addSeries: function(a, b, d) {
          ...
          a &&
            ((b = l(b, !0)),
            p(f, "addSeries", { options: a }, function() {
              c = f.initSeries(a);
              f.isDirtyLegend = !0;
              f.linkSeries();
              p(f, "afterAddSeries");
        ...
        showLoading: function(a) {
          ...
          b.styledMode ||
            (r(f, x(g.style, { zIndex: 10 })),
            r(b.loadingSpan, g.labelStyle),
            b.loadingShown ||
              (r(f, { opacity: 0, display: "" }),
              F(
                f,
        ...
        update: function(d, c, f, m) {
          ...
          t = h && h.width;
          h = h && h.height;
          (g(t) && t !== k.chartWidth) || (g(h) && h !== k.chartHeight)
            ? k.setSize(t, h, m)
            : l(c, !0) && k.redraw(m);
      ...
      x(f.prototype, {
        update: function(a, b, c, f) {
          function k() {
            ...
            t.data[h] =
              d(t.data[h], !0) || d(a, !0) ? e.options : l(a, t.data[h]);
          ...
          var e = this,
            ...
            t = g.options;
          b = l(b, !0);
          !1 === f ? k() : e.firePointEvent("update", { options: a }, k);
        },
        remove: function(a, b) {
      ...
      x(v.prototype, {
        addPoint: function(a, b, d, c) {
          ...
          d &&
            (e[0] && e[0].remove
              ? e[0].remove(!1)
              : (e.shift(), this.updateParallelArrays(h, "shift"), m.shift()));
        ...
        update: function(b, d) {
          ...
          if (D)
            ...
            b = n(
              k,
              u,
              { index: c.index, pointStart: l(k.pointStart, c.xData[0]) },
              { data: c.options.data },
              b
            );
            c.remove(!1, null, !1);
        ...
        { softThreshold: !1, threshold: 0 },
        {
          ...
          getGraphPath: function(a) {
            var c = G.prototype.getGraphPath,
              ...
              H = function(c, g, k) {
                ...
                var p,
                  ...
                  h = !0;
                k || t
                  ? ((p = (t ? c[0] : c[1]) + k), (e = c[0] + k), (h = !!t))
                  : !w && a[g] && a[g].isNull && (p = e = f);
                void 0 !== p &&
                  (m.push({
                    plotX: b,
            ...
            for (p = 0; p < a.length; p++)
              if (
                ((g = a[p].isNull),
                (b = F(a[p].rectPlotX, a[p].plotX)),
                (t = F(a[p].yBottom, v)),
                !g || h)
              )
                h || H(p, p - 1, "left"),
                  (g && !w && h) ||
                    (m.push(a[p]), d.push({ x: p, plotX: b, plotY: t })),
                  h || H(p, p + 1, "right");
            p = c.call(this, m, !0, !0);
            d.reversed = !0;
            g = c.call(this, d, !0, !0);
          ...
          drawGraph: function() {
            ...
            this.zones.forEach(function(c, h) {
              w.push([
                "zone-area-" + h,
                "highcharts-area highcharts-zone-area-" + h + " " + c.className,
                c.color || a.color,
                c.fillColor || u.fillColor
              ]);
            });
            w.forEach(function(c) {
              var p = c[0],
                g = a[p];
              g
                ? ((g.endX = a.preventGraphAnimation ? null : h.xMap),
                  g.animate({ d: h }))
                : ((g = { zIndex: 0 }),
                  a.chart.styledMode ||
                    (g.fill = F(
                      c[3],
                      z(c[2])
                        .setOpacity(F(u.fillOpacity, 0.75))
                        .get()
                    )),
                  (g = a[p] = a.chart.renderer
                    .path(h)
                    .addClass(c[1])
                    .attr(g)
                    .add(a.group)),
        ...
        {},
        {
          getPointSpline: function(a, G, h) {
            ...
            if (
              ...
              g += d;
              x > a && x > r
                ? ((x = Math.max(a, r)), (g = 2 * r - x))
                : x < a && x < r && ((x = Math.min(a, r)), (g = 2 * r - x));
              g > h && g > r
                ? ((g = Math.max(h, r)), (x = 2 * r - g))
                : g < h && g < r && ((g = Math.min(h, r)), (x = 2 * r - g));
              G.rightContX = p;
              G.rightContY = g;
            }
            G = [
              "C",
              z(u.rightContX, u.plotX),
              z(u.rightContY, u.plotY),
              z(w, c),
              z(x, r),
              c,
              r
        ...
        },
        {
          ...
          getColumnMetrics: function() {
            ...
            var t = Math.min(
              ...
              d = Math.min(
                ...
                u(d.pointWidth, r * (1 - 2 * d.pointPadding))
              );
            a.columnMetrics = {
              width: d,
              offset:
                (r - d) / 2 +
                (p + ((a.columnIndex || 0) + (b ? 1 : 0)) * r - t / 2) *
                  (b ? -1 : 1)
            };
          ...
          translate: function() {
            ...
            a.points.forEach(function(c) {
              ...
              v &&
                Math.abs(D) < v &&
                ((D = v),
                (w = (!b.reversed && !c.negative) || (b.reversed && c.negative)),
                c.y === l && a.dataMax <= l && b.min < l && (w = !w),
                (t = Math.abs(t - f) > v ? g - v : f - (w ? v : 0)));
              h(c.options.pointWidth) &&
                ((m = n = Math.ceil(c.options.pointWidth)),
                (e -= Math.round((m - p) / 2)));
              c.barX = e;
              c.pointWidth = m;
              c.tooltipPos = d.inverted
                ? [b.len + b.pos - d.plotLeft - k, a.xAxis.len - e - n / 2, D]
                : [e + n / 2, k + b.pos - d.plotTop, D];
              c.shapeType = c.shapeType || "rect";
              c.shapeArgs = a.crispCol.apply(
                a,
                c.isNull ? [e, f, n, 0] : [e, t, n, D]
              );
            });
          },
          getSymbol: a.noop,
          ...
          pointAttribs: function(a, d) {
            ...
            a &&
              this.zones.length &&
              ((f = a.getZone()),
              (f = a.options.color || (f && f.color) || this.color));
            d &&
              ((a = r(
                c.states[d],
          ...
          drawPoints: function() {
            ...
            a.points.forEach(function(f) {
              ...
              if (c(f.plotY) && null !== f.y) {
                ...
                d.styledMode ||
                  g[m](a.pointAttribs(f, f.selected && "select")).shadow(
                    h.shadow,
                    null,
            ...
            p &&
              (a
                ? ((h.scaleY = 0.001),
                  (a = Math.min(
                    c.pos + c.len,
                    Math.max(c.pos, c.toPixels(g.threshold))
                  )),
                  b ? (h.translateX = a - c.len) : (h.translateY = a),
                  d.clipBox && d.setClip(),
                  d.group.attr(h))
                : ((v = d.group.attr(f)),
                  d.group.animate(
      ...
      F(
        ...
        },
        {
          ...
          applyJitter: function() {
            ...
            h &&
              this.points.forEach(function(r, u) {
                ["x", "y"].forEach(function(w, x) {
                  ...
                  h[w] &&
                    ...
                    p &&
                      !p.isLog &&
                      ((d = Math.max(0, r[g] - m)),
                      (p = Math.min(p.len, r[g] + m)),
                      (x = 1e4 * Math.sin(u + x * c)),
                      (r[g] = d + (p - d) * (x - Math.floor(x))),
                      "x" === w && (r.clientX = r.plotX)));
                });
              });
          }
        }
      ...
      p(
        ...
        },
        {
            ...
            a ||
              (c.forEach(function(a) {
                var c = a.graphic,
                  g = a.shapeArgs;
                c &&
                  (c.attr({ r: a.startR || d.center[3] / 2, start: b, end: b }),
                  c.animate(
          ...
          updateTotals: function() {
            ...
            for (a = 0; a < b; a++)
              (h = g[a]),
                (h.percentage = 0 < c && (h.visible || !f) ? (h.y / c) * 100 : 0),
                (h.total = c);
          },
          generatePoints: function() {
          ...
          getX: function(a, c, g) {
            ...
            return (
              ...
              (c ? -1 : 1) *
                Math.cos(
                  Math.asin(
                    Math.max(Math.min((a - b[1]) / (d + g.labelDistance), 1), -1)
                  )
                ) *
                (d + g.labelDistance) +
              (0 < g.labelDistance
          ...
          translate: function(a) {
            ...
            for (C = 0; C < y; C++) {
              ...
              A = (Math.cos(p) * a[2]) / 2;
              k = (Math.sin(p) * a[2]) / 2;
              e.tooltipPos = [a[0] + 0.7 * A, a[1] + 0.7 * k];
              ...
              e.labelPosition = {
                natural: {
                  ...
                  y: a[1] + k + Math.sin(p) * e.labelDistance
                },
                final: {},
                alignment:
          ...
          drawPoints: function() {
            ...
            !t ||
              a.shadowGroup ||
              c.styledMode ||
              (a.shadowGroup = g.g("shadow").add(a.group));
            a.points.forEach(function(d) {
              ...
              if (d.isNull) l && (d.graphic = l.destroy());
                ...
                if (!c.styledMode) {
                  ...
                  t &&
                    !m &&
                    (m = d.shadowGroup = g.g("shadow").add(a.shadowGroup));
                  m && m.attr(b);
                  f = a.pointAttribs(d, d.selected && "select");
                }
                l
                  ? (l.setRadialReference(a.center),
                    c.styledMode || l.attr(f),
                    l.animate(h(p, b)))
                  : ((d.graphic = l = g[d.shapeType](p)
        ...
        },
        {
          ...
          setVisible: function(a, c) {
            ...
            a !== d.visible &&
              ...
              d.legendItem && g.legend.colorizeItem(d, a),
    ...
    (function(a) {
          ...
          for (h = b.length; h--; )
            (l = b[h]),
              (k =
                ...
                2),
              (l.pos = Math.min(Math.max(0, k - l.size * l.align), c - l.size));
          h = b.length;
          for (l = !1; h--; )
            0 < h &&
              ...
              (b[h - 1].align = 0.5),
              b[h - 1].pos + b[h - 1].size > c &&
                (b[h - 1].pos = c - b[h - 1].size),
              b.splice(h, 1),
              (l = !0));
        }
        m.push.apply(m, n);
            ...
            b.targets.some(function() {
              ...
              if (Math.abs(m[h].pos - m[h].target) > f)
                return (
                  ...
                  m.reducedLen > 0.1 * c && a.distribute(m, c, f),
                  !0
                );
              d += m[h].size;
              h++;
      ...
      p.prototype.drawDataLabels = function() {
        ...
        if (m(p) || p.enabled || f._hasPointLabels)
          (x = f.plotGroup(
            "dataLabelsGroup",
            "data-labels",
            C && !k ? "hidden" : "visible",
            ...
            u.forEach(function(e) {
              A = n(d(p, e.dlOptions || (e.options && e.options.dataLabels)));
              A.forEach(function(d, k) {
                ...
                l &&
                  ((m = e.getLabelConfig()),
                  (q = d[e.formatPrefix + "Format"] || d.format),
                  (m = G(q)
                    ? c(q, m, g.time)
                    : (d[e.formatPrefix + "Formatter"] || d.formatter).call(
                        m,
                        d
                      )),
                  (q = d.style),
                  (t = d.rotation),
                  g.styledMode ||
                    ((q.color = w(d.color, q.color, f.color, "#000000")),
                    "contrast" === q.color &&
                      ((e.contrastColor = y.getContrast(e.color || f.color)),
                      (q.color =
                        d.inside ||
                        0 > w(d.distance, e.labelDistance) ||
                        h.stacking
                          ? e.contrastColor
                          : "#000000")),
                  ...
                  ? l &&
                    ...
                    (p
                      ...
                      : ((e.dataLabels = e.dataLabels || []),
                        (p = e.dataLabels[k] = t
                          ? y.text(m, 0, -9999).addClass("highcharts-data-label")
                          : y.label(
                              m,
                              0,
                              -9999,
                    ...
                    (p.options = d),
                    p.attr(n),
                    g.styledMode || p.css(q).shadow(d.shadow),
                    p.added || p.add(x),
                    f.alignDataLabel(e, p, d, null, v))
                  : ((e.dataLabel = e.dataLabel && e.dataLabel.destroy()),
                    e.dataLabels &&
                      (1 === e.dataLabels.length
                        ? delete e.dataLabels
                        : delete e.dataLabels[k]),
      ...
      p.prototype.alignDataLabel = function(a, c, d, g, m) {
        var b = this.chart,
          ...
          q =
            this.visible &&
            (a.series.forceDL ||
              b.isInsidePlot(l, Math.round(k), f) ||
              (g && b.isInsidePlot(l, f ? g.x + 1 : g.y + g.height - 1, f))),
          r = "justify" === w(d.overflow, "justify");
        if (
          q &&
          ((t = b.renderer.fontMetrics(
          ...
          h(d, { width: n.width, height: n.height }),
          p
            ? ((r = !1),
              (l = b.renderer.rotCorr(t, p)),
              (l = {
                x: g.x + d.x + g.width / 2 + l.x,
                y:
                  g.y +
                  d.y +
                  { top: 0, middle: 0.5, bottom: 1 }[d.verticalAlign] * g.height
              }),
              c[m ? "attr" : "animate"](l).attr({ align: e }),
              (k = (p + 720) % 360),
              (k = 180 < k && 360 > k),
              "left" === e
                ? (l.y -= k ? n.height : 0)
                ...
                : "right" === e && ((l.x -= n.width), (l.y -= k ? 0 : n.height)),
              (c.placed = !0),
              (c.alignAttr = l))
            : (c.align(d, null, g), (l = c.alignAttr)),
          r && 0 <= g.height
            ? (a.isLabelJustified = this.justifyDataLabel(c, d, l, n, g, m))
            : w(d.crop, !0) &&
              (q =
                b.isInsidePlot(l.x, l.y) &&
                b.isInsidePlot(l.x + n.width, l.y + n.height)),
          d.shape && !p)
        )
          c[m ? "attr" : "animate"]({
      ...
      p.prototype.justifyDataLabel = function(a, c, d, g, h, m) {
        ...
        l = d.x + g.width - t;
        l > b.plotWidth &&
          ("left" === f ? (c.align = "right") : (c.x = b.plotWidth - l),
          (n = !0));
        l = d.y + t;
        0 > l &&
          ("bottom" === k ? (c.verticalAlign = "top") : (c.y = -l), (n = !0));
        l = d.y + g.height - t;
        l > b.plotHeight &&
          ("top" === k ? (c.verticalAlign = "bottom") : (c.y = b.plotHeight - l),
          (n = !0));
      ...
      g.pie &&
        ...
        (g.pie.prototype.drawDataLabels = function() {
          ...
          b.visible &&
            ...
            p.prototype.drawDataLabels.apply(b),
            c.forEach(function(a) {
              a.dataLabel &&
                (a.visible
                  ? (R[a.half].push(a),
            ...
            R.forEach(function(c, f) {
              ...
              if (p)
                for (
                  b.sortByAngle(c, f - 0.5),
                    0 < b.maxLabelDistance &&
                      ((l = Math.max(0, z - q - b.maxLabelDistance)),
                      (n = Math.min(z + q + b.maxLabelDistance, g.plotHeight)),
                      c.forEach(function(a) {
                        0 < a.labelDistance &&
                          a.dataLabel &&
                          ((a.top = Math.max(0, z - q - a.labelDistance)),
                          (a.bottom = Math.min(
                            z + q + a.labelDistance,
                            g.plotHeight
                          )),
                  ...
                  K._pos = {
                    x: B + h.x + ({ left: m, right: -m }[J.alignment] || 0),
                    y: P + h.y - 10
                  };
                  J.final.x = B;
                  J.final.y = P;
                  w(h.crop, !0) &&
                    ...
                    (l = null),
                    B - I < m && 1 === f
                      ? ((l = Math.round(I - B + m)), (O[3] = Math.max(l, O[3])))
                      : B + I > r - m &&
                        0 === f &&
                        ((l = Math.round(B + I - r + m)),
                        (O[1] = Math.max(l, O[1]))),
                    0 > P - N / 2
                      ? (O[0] = Math.max(Math.round(-P + N / 2), O[0]))
                      : P + N / 2 > k &&
                        (O[2] = Math.max(Math.round(P + N / 2 - k), O[2])),
                    (K.sideOverflow = l));
                }
            }),
        ...
        (g.pie.prototype.alignDataLabel = u),
        (g.pie.prototype.verifyDataLabelOverflow = function(a) {
          ...
          m ||
            (null !== d[0]
              ? (h = Math.max(b[2] - Math.max(a[1], a[3]), g))
              : ((h = Math.max(b[2] - a[1] - a[3], g)),
                (b[0] += (a[3] - a[1]) / 2)),
            null !== d[1]
              ? (h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), g))
              : ((h = Math.max(Math.min(h, b[2] - a[0] - a[2]), g)),
                (b[1] += (a[0] - a[2]) / 2)),
            h < b[2]
              ? ((b[2] = h),
                (b[3] = Math.min(x(c.innerSize || 0, h), h)),
                this.translate(b),
      ...
      g.column &&
        (g.column.prototype.alignDataLabel = function(a, c, d, g, h) {
          ...
          l &&
            ...
            m ||
              (b
                ? ((g.x += k ? 0 : g.width), (g.width = 0))
                : ((g.y += k ? g.height : 0), (g.height = 0))));
          d.align = w(d.align, !b || m ? "center" : k ? "right" : "left");
          d.verticalAlign = w(
            d.verticalAlign,
            b || m ? "middle" : k ? "top" : "bottom"
          );
      ...
      z.prototype.hideOverlappingLabels = function(a) {
        ...
        for (d = 0; d < h; d++)
          for (l = (m = a[d]) && m.absoluteBox, g = d + 1; g < h; ++g)
            if (
              ((b = (n = a[g]) && n.absoluteBox),
              l &&
                b &&
                m !== n &&
                0 !== m.newOpacity &&
                0 !== n.newOpacity &&
                (b = f(l.x, l.y, l.width, l.height, b.x, b.y, b.width, b.height)))
            )
              (m.labelrank < n.labelrank ? m : n).newOpacity = 0;
        a.forEach(function(a) {
          var b, d;
          a &&
            ((d = a.newOpacity),
            a.oldOpacity !== d &&
              (a.alignAttr && a.placed
                ? (d
                  ...
                  r(c, "afterHideOverlappingLabels"))
                : a.attr({ opacity: d })),
            (a.isOld = !0));
        });
      };
      ...
      v = a.TrackerMixin = {
          ...
          a._hasTracking ||
            (a.trackerGroups.forEach(function(f) {
              if (a[f]) {
                ...
                !b.styledMode &&
                  a.options.cursor &&
                  a[f].css(h).css({ cursor: a.options.cursor });
              }
            }),
            (a._hasTracking = !0));
        ...
        drawTrackerGraph: function() {
          var a = this,
            ...
            u = "rgba(192,192,192," + (f ? 0.0001 : 0.002) + ")";
          if (g && !c)
            for (p = g + 1; p--; )
              "M" === d[p] && d.splice(p + 1, 0, d[p + 1] - e, d[p + 2], "L"),
                ((p && "M" === d[p]) || p === g) &&
                  d.splice(p, 0, "L", d[p - 2] + e, d[p - 1]);
          n
            ? n.attr({ d: d })
            : a.graph &&
              ((a.tracker = m
          ...
          !a || a.resetSelection
            ...
            : a.xAxis.concat(a.yAxis).forEach(function(a) {
                ...
                c[f.isXAxis ? "zoomX" : "zoomY"] &&
                  ((b = f.zoom(a.min, a.max)), f.displayBtn && (d = !0));
              });
          f = this.resetZoomButton;
          d && !f
            ? this.showResetZoom()
            : !d && p(f) && (this.resetZoomButton = f.destroy());
          b &&
            this.redraw(
              m(
          ...
          w(this, "pan", { originalEvent: a }, function() {
            ...
            ("xy" === b ? [1, 0] : [1]).forEach(function(b) {
              ...
              b.series.length &&
                e !== l.min &&
                m !== l.max &&
                (b.setExtremes(e, m, !1, !1, { trigger: "pan" }), (f = !0));
              c[d] = g;
            });
            f && c.redraw(!1);
        ...
        setState: function(a, b) {
          ...
          if (
            ...
            if (this.graphic)
              this.state &&
                ...
                v.styledMode ||
                  this.graphic.animate(
                    ...
                    m(v.options.chart.animation, g.animation)
                  ),
                z &&
                  this.graphic.animate(
                    z,
                    m(v.options.chart.animation, e.animation, h.animation)
                  ),
                p && p.hide();
            else {
              if (a && e) {
                ...
                if (p) p[b ? "animate" : "attr"]({ x: z.x, y: z.y });
                  ...
                  h &&
                    ((f.stateMarkerGraphic = p = v.renderer
              ...
              p &&
                (p[a && v.isInsidePlot(c, d, v.inverted) ? "show" : "hide"](),
              ...
              ? (x ||
                ...
                x.attr({
                  class:
                    ...
                    m(this.colorIndex, f.colorIndex) +
      ...
      u(b.prototype, {
        ...
        setState: function(a) {
          ...
          if (
            ...
            (b.state = a),
            !(b.chart.styledMode || (f[a] && !1 === f[a].enabled)) &&
    ...
    (function(a) {
      ...
      z.prototype.setResponsive = function(c, h) {
        ...
        u = u.toString() || void 0;
        u !== (p && p.ruleIds) &&
          (p && this.update(p.undoOptions, c),
          u
            ? ((p = this.currentOptions(h)),
        ...
        function r(h, p, g, d) {
          ...
          a.objectEach(h, function(a, b) {
            if (!d && -1 < ["series", "xAxis", "yAxis"].indexOf(b))
              for (a = c(a), g[b] = [], m = 0; m < a.length; m++)
                p[b][m] && ((g[b][m] = {}), r(a[m], p[b][m], g[b][m], d + 1));
            else
              G(a)
                ? ((g[b] = F(a) ? [] : {}), r(a, p[b] || {}, g[b], d + 1))
                : (g[b] = p[b] || null);
          });
        }
        var w = {};
