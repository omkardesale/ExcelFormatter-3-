...
(function(h) {
    ...
    (function(a) {
      a.ajax = function(k) {
        ...
        if (!b.url) return !1;
        f.open(b.type.toUpperCase(), b.url, !0);
    ...
    (function(a) {
      ...
      a.dataURLtoBlob = function(a) {
        if (
          ...
          for (
            var f = k.atob(a[3]),
              b = new k.ArrayBuffer(f.length),
              b = new k.Uint8Array(b),
              l = 0;
            l < b.length;
            ++l
          )
      ...
      a.downloadURL = function(c, h) {
        ...
        if ("string" === typeof c || c instanceof String || !b.msSaveOrOpenBlob) {
          ...
          if (void 0 !== d.download)
            ...
            try {
              if (((l = k.open(c, "chart")), void 0 === l || null === l))
    ...
    (function(a) {
      function k(a, b) {
        if (h.Blob && h.navigator.msSaveOrOpenBlob)
          return new h.Blob(["\ufeff" + a], { type: b });
      }
      var b = a.defined,
        f = a.pick,
        h = a.win,
      ...
      a.Chart.prototype.getDataRows = function(l) {
          ...
          B = function(e, b, g) {
            ...
            return e
              ? e instanceof a.Axis
                ...
                : l
                ? { columnTitle: 1 < g ? b : e.name, topLevelColumnTitle: e.name }
                : e.name + (1 < g ? " (" + b + ")" : "")
              : "Category";
          },
          w = [];
        ...
        this.series.forEach(function(e) {
          ...
          if (
            !1 !== e.options.includeInCSVExport &&
            ...
            for (d = 0; d < g; )
              (u = B(e, b[d], b.length)),
                p.push(u.columnTitle || u),
                l && n.push(u.topLevelColumnTitle || u),
                d++;
            A = {
              chart: e.chart,
            ...
            e.options.data.forEach(function(a, l) {
              ...
              q[a].x = p.x;
              q[a].name = c;
              for (q[a].xValues[m] = p.x; d < g; )
                (l = b[d]),
                  (c = p[l]),
                  (q[a][t + d] = f(
                    v[l][c],
                    y[l] ? k.dateFormat(h.dateFormat, c) : null,
                    c
                  )),
                  d++;
            });
              ...
              g &&
                ...
                (g.isDatetimeAxis
                  ? (a.x instanceof Date && (a.x = a.x.getTime()),
                    (e = k.dateFormat(h.dateFormat, a.x)))
                  : (e = g.categories
                      ? f(g.names[a.x], g.categories[a.x], a.x)
                      : a.x));
              a.splice(x, 0, e);
            });
        m = m.concat(d);
      ...
      a.Chart.prototype.getCSV = function(a) {
        var b = "",
          l = this.getDataRows(),
          g = this.options.exporting.csv,
          c = f(
            g.decimalPoint,
            "," !== g.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."
          ),
          k = f(g.itemDelimiter, "," === c ? ";" : ","),
          h = g.lineDelimiter;
      ...
      a.Chart.prototype.getTable = function(b) {
        var c = '\x3ctable id\x3d"highcharts-data-table-' + this.index + '"\x3e',
          l = this.options,
          g = b ? (1.1).toLocaleString()[1] : ".",
          k = f(l.exporting.useMultiLevelHeaders, !0);
        ...
        !1 !== l.exporting.tableCaption &&
          (c +=
            '\x3ccaption class\x3d"highcharts-table-caption"\x3e' +
            f(
              l.exporting.tableCaption,
              l.title.text
                ? l.title.text
                    .replace(/&/g, "\x26amp;")
                    .replace(/</g, "\x26lt;")
        ...
        c += (function(a, b, c) {
              ...
              (e = a[g]),
                ...
                e === f
                  ...
                  ? ((d += n(
                      ...
                      'scope\x3d"col" colspan\x3d"' + (h + 1) + '"',
                      e
                    )),
                    (h = 0))
                  : (e === b[g]
                      ? l.exporting.useRowspanHeaders
                        ? ((f = 2), delete b[g])
                        : ((f = 1), (b[g] = ""))
                      : (f = 1),
                    (d += n(
                      ...
                      "highcharts-table-topheading",
                      'scope\x3d"col"' +
                        (1 < f ? ' valign\x3d"top" rowspan\x3d"' + f + '"' : ""),
                      e
                    )));
            d += "\x3c/tr\x3e";
          }
          if (b) {
            ...
            for (c = b.length; g < c; ++g)
              void 0 !== b[g] && (d += n("th", null, 'scope\x3d"col"', b[g]));
            d += "\x3c/tr\x3e";
          }
          return d + "\x3c/thead\x3e";
        })(h, m, Math.max(d, m.length));
        c += "\x3ctbody\x3e";
        b.forEach(function(a) {
          c += "\x3ctr\x3e";
          for (var b = 0; b < d; b++)
            c += n(b ? "td" : "th", null, b ? "" : 'scope\x3d"row"', a[b]);
          c += "\x3c/tr\x3e";
        });
        ...
        z(
          k(a, "application/vnd.ms-excel") ||
            "data:application/vnd.ms-excel;base64," +
              h.btoa(unescape(encodeURIComponent(a))),
      ...
      d &&
        (a.extend(d.menuItemDefinitions, {
          downloadCSV: {
            textKey: "downloadCSV",
            onclick: function() {
              this.downloadCSV();
        ...
        d.buttons.contextButton.menuItems.push(
          "separator",
          "downloadCSV",
          "downloadXLS",
          "viewData",
