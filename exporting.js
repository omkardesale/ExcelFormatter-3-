...
(function(h) {
    ...
    (function(f, h) {
      ...
      f.post = function(b, a, d) {
        var c = w(
          "form",
          n({ method: "post", action: b, enctype: "multipart/form-data" }, d),
          { display: "none" },
          q.body
        );
        G(a, function(a, b) {
      ...
      z(B.prototype, {
        ...
        getSVGForExport: function(b, a) {
          ...
          return this.getSVG(
            n({ chart: { borderRadius: 0 } }, d.chartOptions, a, {
              exporting: {
        ...
        print: function() {
          ...
          if (!a.isPrinting) {
            ...
            if ((e = m && a.chartWidth > m))
              (k = [a.options.chart.width, void 0, !1]), a.setSize(m, void 0, !1);
        ...
        contextMenu: function(b, a, d, c, v, m, k) {
          ...
          g ||
            ...
            (n = w("div", { className: "highcharts-menu" }, null, g)),
            e.styledMode ||
              y(
                n,
                z(
          ...
          d + e.exportMenuWidth > l
            ? (a.right = l - d - v - C + "px")
            : (a.left = d - C + "px");
          c + m + e.exportMenuHeight > t && "top" !== k.alignOptions.verticalAlign
            ? (a.bottom = t - c - C + "px")
            : (a.top = c + m - C + "px");
          y(g, a);
          e.openMenu = !0;
        ...
        addButton: function(b) {
          ...
          if (!1 !== c.enabled) {
            var l = c.theme,
              ...
              g;
            a.styledMode ||
              ((l.fill = u(l.fill, "#ffffff")), (l.stroke = u(l.stroke, "none")));
            delete l.states;
            f
              ? (g = function(b) {
                  b && b.stopPropagation();
            ...
            c.text && c.symbol
              ? (l.paddingLeft = u(l.paddingLeft, 25))
              : c.text || z(l, { width: c.width, height: c.height, padding: 0 });
            a.styledMode ||
              ((l["stroke-linecap"] = "round"),
              (l.fill = u(l.fill, "#ffffff")),
              (l.stroke = u(l.stroke, "none")));
            e = d
              .button(c.text, 0, 0, g, l, q, t)
              .addClass(b.className)
              .attr({ title: u(a.options.lang[c._titleKey || c.titleKey], "") });
            e.menuClassName =
              b.menuClassName || "highcharts-menu-" + a.btnCount++;
            c.symbol &&
              ((k = d
                .symbol(c.symbol, c.symbolX - h / 2, c.symbolY - h / 2, h, h, {
                  width: h,
                  height: h
                })
            ...
            e.add(a.exportingGroup).align(
              z(c, { width: e.width, x: u(c.x, a.buttonOffset) }),
              !0,
              "spacingBox"
            );
            a.buttonOffset +=
          ...
          b &&
            (b.forEach(function(b, c) {
              b &&
                ...
                a[h] && delete a[h],
                (a.exportSVGElements[c] = b.destroy()));
            }),
            (b.length = 0));
          a.exportingGroup &&
      ...
      B.prototype.inlineStyles = function() {
        ...
        function a(d) {
          function m(a, g) {
            ...
            for (r = f.length; r-- && !p; )
              p = f[r].test(g) || "function" === typeof a;
            p ||
              (q[g] === a && "svg" !== d.nodeName) ||
              e[d.nodeName][g] === a ||
              (-1 !== c.indexOf(g)
                ? d.setAttribute(b(g), a)
                : (u += b(g) + ":" + a + ";"));
          }
          var g,
            q,
          ...
          if (1 === d.nodeType && -1 === k.indexOf(d.nodeName)) {
            ...
            q =
              "svg" === d.nodeName ? {} : A.getComputedStyle(d.parentNode, null);
            e[d.nodeName] ||
              ((x = l.getElementsByTagName("svg")[0]),
              (t = l.createElementNS(d.namespaceURI, d.nodeName)),
              x.appendChild(t),
              (e[d.nodeName] = n(A.getComputedStyle(t, null))),
              "text" === d.nodeName && delete e.text.fill,
              x.removeChild(t));
            if (M || L) for (var w in g) m(g[w], w);
            else G(g, m);
            u &&
              ((g = d.getAttribute("style")),
              d.setAttribute("style", (g ? g + ";" : "") + u));
      ...
      J.menuball = function(b, a, d, c) {
        ...
        c = c / 3 - 2;
        return (b = b.concat(
          this.circle(d - c, a, c, c),
          this.circle(d - c, a + c + 4, c, c),
          this.circle(d - c, a + 2 * (c + 4), c, c)
        ));
      };
